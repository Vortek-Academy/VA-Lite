...
describe("Ascii Table v" + info.version, function () {
  describe("Examples", function () {
    it("default", function () {
      ...
      table2.setHeading(headings).addRow(row).addRowMatrix(matrix);
    ...
    it("dataObjects", function () {
      ...
      table
        .setHeading(headings)
        .addRow(row)
        .addData(arrayData, function (data) {
          return [data.index, data.name, data.age];
        });
  ...
  describe("Static methods", function () {
    ...
    it("#align", function () {
      ase(
        AsciiTable.align(AsciiTable.LEFT, "a", 10),
        AsciiTable.alignLeft("a", 10)
      );
      ase(
        AsciiTable.align(AsciiTable.CENTER, "a", 10),
        AsciiTable.alignCenter("a", 10)
      );
      ase(
        AsciiTable.align(AsciiTable.RIGHT, "a", 10),
        AsciiTable.alignRight("a", 10)
      );
    });
  ...
  describe("Instance methods", function () {
    it("#setBorder", function () {
      ...
      table.setBorder("*").setHeading("one", "two").addRow("abc", "def");
    ...
    it("#toJSON", function () {
      ...
      table.setHeading("one", "two", "three").addRow(1, 2, 3).addRow(4, 5, 6);
