!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, i) {
      "use strict";
      (function (e) {
        const s = (t.Package = i(58)),
          { Error: n, RangeError: r } = i(3),
        ...
        (t.DefaultOptions = {
          ...
          (t.UserAgent = o
            ? null
            : `DiscordBot (${s.homepage.split("#")[0]}, ${s.version}) Node.js/${
                e.version
              }`),
          (t.WSCodes = {
        ...
        const a = ["webp", "png", "jpg", "jpeg", "gif"],
          c = Array.from({ length: 9 }, (e, t) => 2 ** (t + 4));
        ...
        (t.Endpoints = {
          CDN: (e) => ({
            ...
            Avatar: (t, i, s = "webp", n, r = !1) => (
              r && (s = i.startsWith("a_") ? "gif" : s),
              l(`${e}/avatars/${t}/${i}`, { format: s, size: n })
            ),
            Banner: (t, i, s = "webp", n) =>
              l(`${e}/banners/${t}/${i}`, { format: s, size: n }),
            Icon: (t, i, s = "webp", n, r = !1) => (
              r && (s = i.startsWith("a_") ? "gif" : s),
              l(`${e}/icons/${t}/${i}`, { format: s, size: n })
            ),
            AppIcon: (t, i, { format: s = "webp", size: n } = {}) =>
              l(`${e}/app-icons/${t}/${i}`, { size: n, format: s }),
            AppAsset: (t, i, { format: s = "webp", size: n } = {}) =>
              l(`${e}/app-assets/${t}/${i}`, { size: n, format: s }),
            GDMIcon: (t, i, s = "webp", n) =>
              l(`${e}/channel-icons/${t}/${i}`, { size: n, format: s }),
            Splash: (t, i, s = "webp", n) =>
              l(`${e}/splashes/${t}/${i}`, { size: n, format: s }),
            DiscoverySplash: (t, i, s = "webp", n) =>
              l(`${e}/discovery-splashes/${t}/${i}`, { size: n, format: s }),
            TeamIcon: (t, i, { format: s = "webp", size: n } = {}) =>
              l(`${e}/team-icons/${t}/${i}`, { size: n, format: s }),
          }),
          invite: (e, t) => `${e}/${t}`,
          ...
          (t.ClientApplicationAssetTypes = { SMALL: 1, BIG: 2 }),
          (t.Colors = {
            DEFAULT: 0,
            WHITE: 16777215,
            AQUA: 1752220,
          ...
          (t.ExplicitContentFilterLevels = [
            "DISABLED",
            "MEMBERS_WITHOUT_ROLES",
            "ALL_MEMBERS",
          ]),
          (t.VerificationLevels = [
            "NONE",
            "LOW",
            "MEDIUM",
            "HIGH",
          ...
          (t.WebhookTypes = [null, "Incoming", "Channel Follower"]);
      }.call(this, i(14)));
    },
    function (e, t, i) {
      "use strict";
      ...
      e.exports = class GenericAction {
        ...
        getPayload(e, t, i, s, n) {
          ...
          return !r && this.client.options.partials.includes(s)
            ? t.add(e, n)
            : r;
        }
        getChannel(e) {
    ...
    function (e, t, i) {
      ...
      e.exports = class Collection extends s {
        toJSON() {
          return this.map((e) =>
            "function" == typeof e.toJSON ? e.toJSON() : n.flatten(e)
          );
        }
      };
    },
    function (e, t, i) {
      "use strict";
      (e.exports = i(59)), (e.exports.Messages = i(98));
    },
    function (e, t, i) {
      "use strict";
      const { parse: s } = i(35),
        n = i(36),
        { Colors: r, DefaultOptions: o, Endpoints: a } = i(0),
        { Error: c, RangeError: l, TypeError: h } = i(3),
      ...
      class Util {
        ...
        static flatten(e, ...t) {
          ...
          for (let [n, r] of Object.entries(t)) {
            ...
            t instanceof i(2)
              ? (s[r] = Array.from(t.keys()))
              : a instanceof i(2)
              ? (s[r] = Array.from(a.keys()))
              : Array.isArray(t)
              ? (s[r] = t.map((e) => Util.flatten(e)))
              : "object" != typeof a
              ? (s[r] = a)
              : o || (s[r] = t);
          }
        ...
        static splitMessage(
          ...
          let a = "";
          for (const e of r)
            a && (a + i + e + n).length > t && (o.push(a + n), (a = s)),
              (a += (a && a !== s ? i : "") + e);
        ...
        static escapeMarkdown(
          ...
          return c
            ? l
              ? (i && (e = Util.escapeInlineCode(e)),
                t && (e = Util.escapeCodeBlock(e)),
                n && (e = Util.escapeItalic(e)),
                s && (e = Util.escapeBold(e)),
                r && (e = Util.escapeUnderline(e)),
                o && (e = Util.escapeStrikethrough(e)),
                a && (e = Util.escapeSpoiler(e)),
                e)
              : e
                  .split(/(?<=^|[^`])`(?=[^`]|$)/g)
                  .map((e, i, c) =>
        ...
        static escapeItalic(e) {
          ...
          return (
            ...
            (t = 0),
            e.replace(/(?<=^|[^_])_([^_]|__|$)/g, (e, i) =>
              "__" === i ? (++t % 2 ? `\\_${i}` : `${i}\\_`) : `\\_${i}`
            )
          );
        }
        static escapeBold(e) {
        ...
        static parseEmoji(e) {
          ...
          return t
            ? { animated: Boolean(t[1]), name: t[2], id: t[3] || null }
            : null;
        }
        ...
        static mergeDefault(e, t) {
          ...
          for (const n in e)
            (i = t),
              (s = n),
              Object.prototype.hasOwnProperty.call(i, s) && void 0 !== t[n]
                ? t[n] === Object(t[n]) &&
                  (t[n] = Util.mergeDefault(e[n], t[n]))
                : (t[n] = e[n]);
          var i, s;
          return t;
        }
        ...
        static discordSort(e) {
          return e.sorted(
            (e, t) =>
              ...
              parseInt(t.id.slice(0, -10)) - parseInt(e.id.slice(0, -10)) ||
              parseInt(t.id.slice(10)) - parseInt(e.id.slice(10))
          );
        }
        static setPosition(e, t, i, s, n, r) {
          let o = s.array();
          return (
            Util.moveElementInArray(o, e, t, i),
        ...
        static idToBinary(e) {
          let t = "",
            i = parseInt(e.slice(0, -10)) || 0,
            s = parseInt(e.slice(-10));
          for (; s > 0 || i > 0; )
            (t = String(1 & s) + t),
              (s = Math.floor(s / 2)),
              i > 0 && ((s += (i % 2) * 5e9), (i = Math.floor(i / 2)));
          return t;
        }
        static binaryToID(e) {
          let t = "";
          for (; e.length > 50; ) {
            const i = parseInt(e.slice(0, -32), 2),
              s = parseInt((i % 10).toString(2) + e.slice(-32), 2);
            (t = (s % 10).toString() + t),
              (e =
                Math.floor(i / 10).toString(2) +
                Math.floor(s / 10)
                  .toString(2)
                  .padStart(32, "0"));
          }
          for (e = parseInt(e, 2); e > 0; )
            (t = (e % 10).toString() + t), (e = Math.floor(e / 10));
          return t;
        }
        ...
        static cleanContent(e, t) {
          return (
            ...
            "everyone" === t.client.options.disableMentions &&
              (e = e.replace(/@([^<>@ ]*)/gmsu, (e, t) =>
                t.match(/^[&!]?\d+$/) ? `@${t}` : `@​${t}`
              )),
            "all" === t.client.options.disableMentions
              ? Util.removeMentions(e)
              : e
          );
        }
    ...
    function (e, t, i) {
      ...
      e.exports = class BaseManager {
        ...
        resolve(e) {
          return e instanceof this.holds
            ? e
            : ("string" == typeof e && this.cache.get(e)) || null;
        }
        resolveID(e) {
          return e instanceof this.holds
            ? e.id
    ...
    function (e, t, i) {
      ...
      e.exports = class SnowflakeUtil {
        ...
        static generate(e = Date.now()) {
          ...
          n >= 4095 && (n = 0);
          const t = `${(e - 14200704e5)
            .toString(2)
            .padStart(42, "0")}0000100000${(n++)
            .toString(2)
            .padStart(12, "0")}`;
          return s.binaryToID(t);
        }
        static deconstruct(e) {
          const t = s.idToBinary(e).toString(2).padStart(64, "0"),
            i = {
    ...
    function (e, t, i) {
      ...
      class Permissions extends s {
        any(e, t = !0) {
          return (
            (t && super.has(this.constructor.FLAGS.ADMINISTRATOR)) ||
            super.any(e)
          );
        }
        has(e, t = !0) {
    ...
    function (e, t, i) {
      ...
      class DataResolver {
        ...
        static resolveInviteCode(e) {
          const t = /discord(?:app\.com\/invite|\.gg(?:\/invite)?)\/([\w-]{2,255})/i.exec(
            e
          );
          return t && t[1] ? t[1] : e;
        }
        ...
        static async resolveFile(e) {
          if (!l && Buffer.isBuffer(e)) return e;
              ...
              return new Promise((t, i) => {
                ...
                s.stat(r, (e, n) =>
                  e
                    ? i(e)
                    : n.isFile()
                    ? t(s.createReadStream(r))
                    : i(new a("FILE_NOT_FOUND", r))
                );
              });
          }
        ...
        static async resolveFileAsBuffer(e) {
          ...
          const i = [];
          for await (const e of t) i.push(e);
    ...
    function (e, t, i) {
      ...
      class GuildMember extends s {
        constructor(e, t, i) {
          super(e),
            (this.guild = i),
            t.user && (this.user = e.users.add(t.user, !0)),
        ...
        _patch(e) {
          void 0 !== e.nick && (this.nickname = e.nick),
            e.joined_at &&
              (this.joinedTimestamp = new Date(e.joined_at).getTime()),
            e.premium_since &&
              (this.premiumSinceTimestamp = new Date(
                e.premium_since
              ).getTime()),
            e.user && (this.user = this.guild.client.users.add(e.user)),
            e.roles && (this._roles = e.roles);
        }
        _clone() {
        ...
        get voice() {
          return (
            ...
            new o(this.guild, { user_id: this.id })
          );
        }
        get joinedAt() {
        ...
        get presence() {
          return (
            ...
            new n(this.client, { user: { id: this.id }, guild: this.guild })
          );
        }
        get displayColor() {
        ...
        get permissions() {
          return this.user.id === this.guild.ownerID
            ? new h(h.ALL).freeze()
            : new h(this.roles.cache.map((e) => e.permissions)).freeze();
        }
        get manageable() {
          ...
          return (
            this.guild.me.roles.highest.comparePositionTo(this.roles.highest) >
            0
          );
        }
        get kickable() {
          return (
            this.manageable &&
            this.guild.me.permissions.has(h.FLAGS.KICK_MEMBERS)
          );
        }
        get bannable() {
          return (
            this.manageable &&
            this.guild.me.permissions.has(h.FLAGS.BAN_MEMBERS)
          );
        }
        permissionsIn(e) {
          if (!(e = this.guild.channels.resolve(e)))
            throw new c("GUILD_CHANNEL_RESOLVE");
          return e.memberPermissions(this);
        }
        hasPermission(e, { checkAdmin: t = !0, checkOwner: i = !0 } = {}) {
          return (
            !(!i || this.user.id !== this.guild.ownerID) ||
            this.roles.cache.some((i) => i.permissions.has(e, t))
          );
        }
        async edit(e, t) {
          if (e.channel) {
            if (
              ((e.channel = this.guild.channels.resolve(e.channel)),
              !e.channel || "voice" !== e.channel.type)
            )
              throw new c("GUILD_VOICE_CHANNEL_RESOLVE");
            (e.channel_id = e.channel.id), (e.channel = void 0);
          } else
            null === e.channel && ((e.channel_id = null), (e.channel = void 0));
          e.roles &&
            (e.roles = e.roles.map((e) => (e instanceof r ? e.id : e)));
      ...
      class BitField {
        ...
        has(e) {
          return Array.isArray(e)
            ...
            : ((e = this.constructor.resolve(e)), (this.bitfield & e) === e);
        }
        missing(e, ...t) {
          return (
            Array.isArray(e) || (e = new this.constructor(e).toArray(!1)),
        ...
        *[Symbol.iterator]() {
        ...
        static resolve(e = 0) {
          ...
          if ("string" == typeof e && void 0 !== this.FLAGS[e])
            return this.FLAGS[e];
    ...
    function (e, t, i) {
      ...
      class Webhook {
          ...
          (this.name = e.name),
            ...
            e.user
              ? (this.owner = this.client.users
                  ? this.client.users.cache.get(e.user.id)
                  : e.user)
              : (this.owner = null);
        }
        async send(e, t) {
          let i;
          if (e instanceof s) i = e.resolveData();
          else if (
            ((i = s.create(this, e, t).resolveData()),
            Array.isArray(i.data.content))
          )
            return Promise.all(i.split().map(this.send.bind(this)));
          const { data: n, files: r } = await i.resolveFiles();
          return this.client.api
            .webhooks(this.id, this.token)
            .post({ data: n, files: r, query: { wait: !0 }, auth: !1 })
            .then((e) => {
              const t = this.client.channels
                ? this.client.channels.cache.get(e.channel_id)
                : void 0;
        ...
        sendSlackMessage(e) {
          return this.client.api
            .webhooks(this.id, this.token)
            .slack.post({ query: { wait: !0 }, auth: !1, data: e })
        ...
        async edit({ name: e = this.name, avatar: t, channel: i }, s) {
          t &&
            "string" == typeof t &&
            !t.startsWith("data:") &&
            (t = await o.resolveImage(t)),
            i && (i = i instanceof n ? i.id : i);
          const r = await this.client.api
            .webhooks(this.id, i ? void 0 : this.token)
            .patch({ data: { name: e, avatar: t, channel_id: i }, reason: s });
          return (
            (this.name = r.name),
            (this.avatar = r.avatar),
            (this.channelID = r.channel_id),
            this
          );
        }
        delete(e) {
        ...
        avatarURL({ format: e, size: t } = {}) {
          return this.avatar
            ? this.client.rest.cdn.Avatar(this.id, this.avatar, e, t)
            : null;
        }
        static applyToClass(e) {
          for (const t of [
            ...
            Object.defineProperty(
              e.prototype,
              t,
              Object.getOwnPropertyDescriptor(Webhook.prototype, t)
            );
        }
      }
      e.exports = Webhook;
        ...
        constructor(e, t) {
          Object.defineProperty(this, "presence", { value: e }),
            ...
            (this.assets = t.assets
              ? new RichPresenceAssets(this, t.assets)
              : null),
            (this.syncID = t.sync_id),
            (this.flags = new n(t.flags).freeze()),
            (this.emoji = t.emoji ? new s(e.client, t.emoji) : null),
            (this.createdTimestamp = new Date(t.created_at).getTime());
        }
        equals(e) {
          return (
            this === e ||
      ...
      class RichPresenceAssets {
        ...
        smallImageURL({ format: e, size: t } = {}) {
          return this.smallImage
            ? this.activity.presence.client.rest.cdn.AppAsset(
        ...
        largeImageURL({ format: e, size: t } = {}) {
          return this.largeImage
            ? /^spotify:/.test(this.largeImage)
              ...
              : /^twitch:/.test(this.largeImage)
              ? `https://static-cdn.jtvnw.net/previews-ttv/live_user_${this.largeImage.slice(
                  7
                )}.png`
              : this.activity.presence.client.rest.cdn.AppAsset(
                  this.activity.applicationID,
      ...
      (t.Presence = class Presence {
        ...
        patch(e) {
          return (
            ...
            e.activities
              ? (this.activities = e.activities.map(
                  (e) => new Activity(this, e)
                ))
              : e.activity || e.game
              ? (this.activities = [new Activity(this, e.game || e.activity)])
              : (this.activities = []),
    ...
    function (e, t) {
      ...
      function d() {
        h &&
          c &&
          ((h = !1), c.length ? (l = c.concat(l)) : (u = -1), l.length && p());
      }
      function p() {
        if (!h) {
          var e = a(d);
    ...
    function (e, t, i) {
      ...
      e.exports = class Channel extends s {
        constructor(e, t) {
          ...
          (this.type = i ? i.toLowerCase() : "unknown"),
            (this.deleted = !1),
            t && this._patch(t);
        }
        _patch(e) {
      ...
      e.exports = class GuildChannel extends s {
        ...
        _patch(e) {
          if (
            ...
            (this.permissionOverwrites = new l()),
        ...
        get permissionsLocked() {
          return this.parent
            ? this.permissionOverwrites.size ===
                this.parent.permissionOverwrites.size &&
                this.permissionOverwrites.every((e, t) => {
                  const i = this.parent.permissionOverwrites.get(t);
                  return (
                    void 0 !== i &&
                    i.deny.bitfield === e.deny.bitfield &&
                    i.allow.bitfield === e.allow.bitfield
                  );
                })
            : null;
        }
        ...
        memberPermissions(e) {
          ...
          const t = e.roles.cache,
            i = new h(t.map((e) => e.permissions));
          if (i.has(h.FLAGS.ADMINISTRATOR)) return new h(h.ALL).freeze();
          const s = this.overwritesFor(e, !0, t);
          return i
            .remove(s.everyone ? s.everyone.deny : 0)
            .add(s.everyone ? s.everyone.allow : 0)
            .remove(s.roles.length > 0 ? s.roles.map((e) => e.deny) : 0)
            .add(s.roles.length > 0 ? s.roles.map((e) => e.allow) : 0)
            .remove(s.member ? s.member.deny : 0)
            .add(s.member ? s.member.allow : 0)
            .freeze();
        }
        rolePermissions(e) {
          if (e.permissions.has(h.FLAGS.ADMINISTRATOR))
            return new h(h.ALL).freeze();
          const t = this.permissionOverwrites.get(this.guild.id),
            i = this.permissionOverwrites.get(e.id);
        ...
        overwritePermissions(e, t) {
          return Array.isArray(e) || e instanceof l
            ? this.edit({ permissionOverwrites: e, reason: t }).then(() => this)
            : Promise.reject(
                new c(
                  "INVALID_TYPE",
                  "overwrites",
        ...
        updateOverwrite(e, t, i) {
          if (
            !(e = this.guild.roles.resolve(e) || this.client.users.resolve(e))
          )
            return Promise.reject(
              new c("INVALID_TYPE", "parameter", "User nor a Role", !0)
            );
          const s = this.permissionOverwrites.get(e.id);
          return s
            ? s.update(t, i).then(() => this)
            : this.createOverwrite(e, t, i);
        }
        createOverwrite(e, t, i) {
          ...
          const s = e instanceof o ? "role" : "member",
            { allow: n, deny: a } = r.resolveOverwriteOptions(t);
          return this.client.api
            .channels(this.id)
            .permissions[e.id].put({
              data: { id: e.id, type: s, allow: n.bitfield, deny: a.bitfield },
              reason: i,
            })
            .then(() => this);
        }
        lockPermissions() {
          if (!this.parent)
            return Promise.reject(new a("GUILD_CHANNEL_ORPHAN"));
          const e = this.parent.permissionOverwrites.map((e) => e.toJSON());
          return this.edit({ permissionOverwrites: e });
        }
        get members() {
          const e = new l();
          for (const t of this.guild.members.cache.values())
            this.permissionsFor(t).has("VIEW_CHANNEL", !1) && e.set(t.id, t);
          return e;
        }
        async edit(e, t) {
          void 0 !== e.position &&
          ...
          const i =
              ...
              e.permissionOverwrites.map((e) => r.resolve(e, this.guild)),
            s = await this.client.api
              .channels(this.id)
              .patch({
                data: {
                  ...
                  user_limit:
                    void 0 !== e.userLimit ? e.userLimit : this.userLimit,
        ...
        createInvite({
          ...
          return this.client.api
            .channels(this.id)
            .invites.post({
              data: { temporary: e, max_age: t, max_uses: i, unique: s },
              reason: r,
            })
        ...
        clone(e = {}) {
          return (
            ...
            this.guild.channels.create(e.name, e)
          );
        }
        equals(e) {
          let t =
        ...
        get manageable() {
          if (this.client.user.id === this.guild.ownerID) return !0;
          if ("voice" === this.type) {
            if (!this.permissionsFor(this.client.user).has(h.FLAGS.CONNECT, !1))
              return !1;
    ...
    function (e, t, i) {
      ...
      e.exports = class Invite extends s {
        ...
        _patch(e) {
          (this.guild = e.guild ? this.client.guilds.add(e.guild, !1) : null),
            (this.code = e.code),
            (this.presenceCount =
              "approximate_presence_count" in e
                ? e.approximate_presence_count
                : null),
            (this.memberCount =
              "approximate_member_count" in e
                ? e.approximate_member_count
                : null),
            (this.temporary = "temporary" in e ? e.temporary : null),
            (this.maxAge = "max_age" in e ? e.max_age : null),
            (this.uses = "uses" in e ? e.uses : null),
            (this.maxUses = "max_uses" in e ? e.max_uses : null),
            (this.inviter = e.inviter
              ? this.client.users.add(e.inviter)
              : null),
            (this.targetUser = e.target_user
              ? this.client.users.add(e.target_user)
              : null),
            (this.targetUserType =
              "number" == typeof e.target_user_type
                ? e.target_user_type
                : null),
            (this.channel = this.client.channels.add(
              e.channel,
              this.guild,
              !1
            )),
            (this.createdTimestamp =
              "created_at" in e ? new Date(e.created_at).getTime() : null);
        }
        get createdAt() {
        ...
        get deletable() {
          ...
          return (
            this.channel
              ...
              .has(r.FLAGS.MANAGE_CHANNELS, !1) ||
            e.me.permissions.has(r.FLAGS.MANAGE_GUILD)
          );
        }
        get expiresTimestamp() {
          return this.createdTimestamp && this.maxAge
            ? this.createdTimestamp + 1e3 * this.maxAge
            : null;
        }
        get expiresAt() {
        ...
        delete(e) {
          return this.client.api.invites[this.code]
            .delete({ reason: e })
            .then(() => this);
        }
        toString() {
      ...
      e.exports = class Role extends s {
        ...
        _patch(e) {
          (this.id = e.id),
            ...
            (this.hoist = e.hoist),
            (this.rawPosition = e.position),
            (this.permissions = new o(e.permissions).freeze()),
        ...
        get editable() {
          ...
          return (
            !!e.permissions.has(o.FLAGS.MANAGE_ROLES) &&
            e.roles.highest.comparePositionTo(this) > 0
          );
        }
        get position() {
        ...
        comparePositionTo(e) {
          if (!(e = this.guild.roles.resolve(e)))
            throw new r("INVALID_TYPE", "role", "Role nor a Snowflake");
          return this.constructor.comparePositions(this, e);
        }
        async edit(e, t) {
          return (
            void 0 !== e.permissions
              ? (e.permissions = o.resolve(e.permissions))
              : (e.permissions = this.permissions.bitfield),
            void 0 !== e.position &&
              (await c
                .setPosition(
                  this,
            ...
            this.client.api.guilds[this.guild.id].roles[this.id]
              .patch({
                data: {
                  ...
                  color:
                    null !== e.color
                      ? c.resolveColor(e.color || this.color)
                      : null,
                  hoist: void 0 !== e.hoist ? e.hoist : this.hoist,
                  permissions: e.permissions,
                  mentionable:
                    void 0 !== e.mentionable ? e.mentionable : this.mentionable,
                },
                reason: t,
              })
              .then((e) => {
        ...
        permissionsIn(e) {
          if (!(e = this.guild.channels.resolve(e)))
            throw new n("GUILD_CHANNEL_RESOLVE");
    ...
    function (e, t, i) {
      ...
      const s = {
        ...
        TextChannel: i(41),
        VoiceChannel: i(79),
        CategoryChannel: i(80),
        NewsChannel: i(81),
        StoreChannel: i(82),
        GuildMember: i(10),
        Guild: i(53),
        Message: i(28),
        MessageReaction: i(51),
      ...
      e.exports = class Structures {
        ...
        static get(e) {
          ...
          throw new TypeError(
            `"structure" argument must be a string (received ${typeof e})`
          );
        }
        static extend(e, t) {
          if (!s[e])
            throw new RangeError(`"${e}" is not a valid extensible structure.`);
          if ("function" != typeof t) {
            throw new TypeError(
              `"extender" argument must be a function that returns the extended structure class/prototype ${`(received ${typeof t})`}.`
            );
          }
          const i = t(s[e]);
          if ("function" != typeof i) {
            throw new TypeError(
              `The extender function must return the extended structure class/prototype ${`(received ${typeof i})`}.`
            );
          }
          if (!(i.prototype instanceof s[e])) {
            ...
            throw new Error(
              "The class/prototype returned from the extender function must extend the existing structure class/prototype" +
                ` (received function ${n}; expected extension of ${s[e].name}).`
            );
          }
          return (s[e] = i), i;
        }
    ...
    function (e, t, i) {
      ...
      class GuildEmoji extends s {
        ...
        get deletable() {
          ...
          return (
            !this.managed && this.guild.me.hasPermission(o.FLAGS.MANAGE_EMOJIS)
          );
        }
        get roles() {
          return new r(this);
        ...
        fetchAuthor() {
          return this.managed
            ? Promise.reject(new n("EMOJI_MANAGED"))
            : this.guild.me
            ? this.guild.me.permissions.has(o.FLAGS.MANAGE_EMOJIS)
              ? this.client.api
                  .guilds(this.guild.id)
                  .emojis(this.id)
                  .get()
                  .then((e) => this.client.users.add(e.user))
              : Promise.reject(
                  new n("MISSING_MANAGE_EMOJIS_PERMISSION", this.guild)
                )
            : Promise.reject(new n("GUILD_UNCACHED_ME"));
        }
        edit(e, t) {
          ...
          return this.client.api
            .guilds(this.guild.id)
            .emojis(this.id)
            .patch({ data: { name: e.name, roles: i }, reason: t })
            .then((e) => {
              const t = this._clone();
              return t._patch(e), t;
            });
        ...
        equals(e) {
          return e instanceof GuildEmoji
            ? e.id === this.id &&
                e.name === this.name &&
    ...
    function (e, t, i) {
      ...
      class User extends s {
        constructor(e, t) {
          super(e),
            (this.id = t.id),
            (this.bot = Boolean(t.bot)),
            this._patch(t);
        }
        _patch(e) {
          e.username && (this.username = e.username),
            e.discriminator && (this.discriminator = e.discriminator),
            void 0 !== e.avatar && (this.avatar = e.avatar),
            void 0 !== e.bot && (this.bot = Boolean(e.bot)),
            void 0 !== e.system && (this.system = Boolean(e.system)),
            e.locale && (this.locale = e.locale),
            void 0 !== e.public_flags && (this.flags = new c(e.public_flags)),
            (this.lastMessageID = null),
            (this.lastMessageChannelID = null);
        }
        get partial() {
        ...
        get presence() {
          for (const e of this.client.guilds.cache.values())
            if (e.presences.cache.has(this.id))
              return e.presences.cache.get(this.id);
          return new n(this.client, { user: { id: this.id } });
        }
        avatarURL({ format: e, size: t, dynamic: i } = {}) {
          return this.avatar
            ? this.client.rest.cdn.Avatar(this.id, this.avatar, e, t, i)
            : null;
        }
        ...
        get dmChannel() {
          return (
            this.client.channels.cache.find(
              (e) => "dm" === e.type && e.recipient.id === this.id
            ) || null
          );
        }
        async createDM() {
          ...
          const t = await this.client.api
            .users(this.client.user.id)
            .channels.post({ data: { recipient_id: this.id } });
      ...
      e.exports = class VoiceState extends s {
        ...
        _patch(e) {
          return (
            ...
            (this.streaming = e.self_stream || !1),
            (this.channelID = e.channel_id),
            this
          );
        }
        ...
        get connection() {
          return o || this.id !== this.client.user.id
            ? null
            : this.client.voice.connections.get(this.guild.id) || null;
        }
        get deaf() {
        ...
        setMute(e, t) {
          return this.member
            ? this.member.edit({ mute: e }, t)
            : Promise.reject(new n("VOICE_STATE_UNCACHED_MEMBER"));
        }
        setDeaf(e, t) {
          return this.member
            ? this.member.edit({ deaf: e }, t)
            : Promise.reject(new n("VOICE_STATE_UNCACHED_MEMBER"));
        }
        kick(e) {
        ...
        setChannel(e, t) {
          return this.member
            ? this.member.edit({ channel: e }, t)
            : Promise.reject(new n("VOICE_STATE_UNCACHED_MEMBER"));
        }
        async setSelfMute(e) {
          if (this.id !== this.client.user.id)
            throw new n("VOICE_STATE_NOT_OWN");
          if ("boolean" != typeof e)
            throw new r("VOICE_STATE_INVALID_TYPE", "mute");
          return (
            !!this.connection &&
            ((this.selfMute = e),
        ...
        async setSelfDeaf(e) {
          return this.id !== this.client.user.id
            ? new n("VOICE_STATE_NOT_OWN")
            : "boolean" != typeof e
            ? new r("VOICE_STATE_INVALID_TYPE", "deaf")
            : !!this.connection &&
              ((this.selfDeaf = e),
              await this.connection.sendVoiceStateUpdate(),
              !0);
      ...
      e.exports = class Message extends n {
        ...
        _patch(e) {
          if (
            ...
            (this.author = e.author
              ? this.client.users.add(e.author, !e.webhook_id)
              : null),
            (this.pinned = e.pinned),
            (this.tts = e.tts),
            (this.nonce = e.nonce),
            (this.system = 0 !== e.type),
            (this.embeds = (e.embeds || []).map((e) => new a(e, !0))),
            (this.attachments = new p()),
            e.attachments)
          )
            for (const t of e.attachments)
              this.attachments.set(t.id, new o(t.url, t.filename, t));
          if (
          ...
          (this.mentions = new c(
            ...
            (this.application = e.application
              ? new r(this.client, e.application)
              : null),
            (this.activity = e.activity
              ? { partyID: e.activity.party_id, type: e.activity.type }
              : null),
            (this._edits = []),
            ...
            (this.flags = new m(e.flags).freeze()),
            (this.reference = e.message_reference
              ? {
        ...
        patch(e) {
          ...
          (this.mentions = new c(
            ...
            "mention_roles" in e ? e.mention_roles : this.mentions.roles,
            "mention_everyone" in e
              ? e.mention_everyone
              : this.mentions.everyone,
            "mention_channels" in e
              ? e.mention_channels
              : this.mentions.crosspostedChannels
          )),
            (this.flags = new m("flags" in e ? e.flags : 0).freeze());
        }
        get member() {
        ...
        get cleanContent() {
          return null != this.content
            ? E.cleanContent(this.content, this)
            : null;
        }
        ...
        react(e) {
          if (!(e = this.client.emojis.resolveIdentifier(e)))
            throw new u("EMOJI_TYPE");
          return this.client.api
            .channels(this.channel.id)
            .messages(this.id)
            .reactions(e, "@me")
        ...
        delete(e = {}) {
          if ("object" != typeof e)
            throw new u("INVALID_TYPE", "options", "object", !0);
          const { timeout: t = 0, reason: i } = e;
          return t <= 0
            ? this.channel.messages.delete(this.id, i).then(() => this)
            : new Promise((e) => {
        ...
        reply(e, t) {
          return this.channel.send(
            e instanceof s
              ? e
              : s.transformOptions(e, t, { reply: this.member || this.author })
          );
        }
        fetch() {
        ...
        fetchWebhook() {
          return this.webhookID
            ...
            : Promise.reject(new h("WEBHOOK_MESSAGE"));
        }
        suppressEmbeds(e = !0) {
          const t = new m(this.flags.bitfield);
          return (
            e
              ? t.add(m.FLAGS.SUPPRESS_EMBEDS)
              : t.remove(m.FLAGS.SUPPRESS_EMBEDS),
            this.edit({ flags: t })
          );
        }
        equals(e, t) {
            ...
            i &&
              ...
              (i =
                ...
                this.editedTimestamp ===
                  new Date(t.edited_timestamp).getTime()),
            i
          );
        }
        toString() {
    ...
    function (e, t, i) {
      ...
      class APIMessage {
        ...
        makeContent() {
          const e = i(10);
          let t;
          null === this.options.content
            ? (t = "")
            : void 0 !== this.options.content &&
              (t = l.resolveString(this.options.content));
          const s =
            void 0 === this.options.disableMentions
              ? this.target.client.options.disableMentions
              : this.options.disableMentions;
          "all" === s
            ? (t = l.removeMentions(t || ""))
            : "everyone" === s &&
              (t = (t || "").replace(/@([^<>@ ]*)/gmsu, (e, t) =>
                t.match(/^[&!]?\d+$/) ? `@${t}` : `@​${t}`
              ));
          ...
          if (this.options.reply && !this.isUser && "dm" !== this.target.type) {
            ...
            (a = `<@${
              this.options.reply instanceof e && this.options.reply.nickname
                ? "!"
                : ""
            }${t}>, `),
              n && (o.prepend = `${a}${o.prepend || ""}`);
          }
          if (t || a) {
            if (r) {
              const e =
                "string" == typeof this.options.code ? this.options.code : "";
              (t = `${a}\`\`\`${e}\n${l.cleanCodeBlockContent(
                t || ""
              )}\n\`\`\``),
                n &&
                  ((o.prepend = `${o.prepend || ""}\`\`\`${e}\n`),
                  (o.append = `\n\`\`\`${o.append || ""}`));
            } else a && (t = `${a}${t || ""}`);
        ...
        resolveData() {
          ...
          let i;
          if (
            void 0 !== this.options.nonce &&
            ((i = parseInt(this.options.nonce)), isNaN(i) || i < 0)
          )
            throw new r("MESSAGE_NONCE_TYPE");
          const s = [];
          this.isWebhook
            ? this.options.embeds && s.push(...this.options.embeds)
            : this.options.embed && s.push(this.options.embed);
          const o = s.map((e) => new n(e).toJSON());
          let a, l, h;
          this.isWebhook &&
            ((a = this.options.username || this.target.name),
            this.options.avatarURL && (l = this.options.avatarURL)),
            this.isMessage &&
              (h =
                null != this.options.flags
                  ? new c(this.options.flags).bitfield
                  : this.target.flags.bitfield);
          const u =
            void 0 === this.options.allowedMentions
        ...
        async resolveFiles() {
          ...
          const e = [];
          this.isWebhook
            ? this.options.embeds && e.push(...this.options.embeds)
            : this.options.embed && e.push(this.options.embed);
          const t = [];
          this.options.files && t.push(...this.options.files);
          for (const i of e) i.files && t.push(...i.files);
          return (
            (this.files = await Promise.all(
              t.map((e) => this.constructor.resolveFile(e))
            )),
            this
          );
        }
        split() {
          if (
            (this.data || this.resolveData(), !Array.isArray(this.data.content))
          )
            return [this];
          const e = [];
          for (let t = 0; t < this.data.content.length; t++) {
            let i, s;
            t === this.data.content.length - 1
              ? ((i = { ...this.data, content: this.data.content[t] }),
                (s = { ...this.options, content: this.data.content[t] }))
        ...
        static async resolveFile(e) {
          ...
          return (
            "string" == typeof e ||
            e instanceof (o ? ArrayBuffer : Buffer) ||
            "function" == typeof e.pipe
              ? ((t = e), (i = s(t)))
              : ((t = e.attachment), (i = e.name || s(t))),
            { attachment: t, name: i, file: await a.resolveFile(t) }
          );
        }
        static partitionMessageAdditions(e) {
          const t = [],
            i = [];
          for (const r of e)
            r instanceof n ? t.push(r) : r instanceof s && i.push(r);
          return [t, i];
        }
        static transformOptions(e, t, i = {}, r = !1) {
          ...
          if (Array.isArray(t)) {
            ...
            return r
              ? { content: e, embeds: s, files: n, ...i }
              : { content: e, embed: s[0], files: n, ...i };
          }
          if (Array.isArray(e)) {
    ...
    function (e, t, i) {
      ...
      const s = i(71),
        ...
        r = i(7),
        o = i(2),
        { RangeError: a, TypeError: c } = i(3);
      class TextBasedChannel {
        constructor() {
          (this.messages = new l(this)),
            (this.lastMessageID = null),
        ...
        async send(e, t) {
          ...
          if (this instanceof s || this instanceof r)
            return this.createDM().then((i) => i.send(e, t));
          let o;
          if (e instanceof n) o = e.resolveData();
          else if (
            ((o = n.create(this, e, t).resolveData()),
            Array.isArray(o.data.content))
          )
            return Promise.all(o.split().map(this.send.bind(this)));
        ...
        async bulkDelete(e, t = !1) {
          if (Array.isArray(e) || e instanceof o) {
            ...
            if (
              (t &&
                (i = i.filter(
                  (e) => Date.now() - r.deconstruct(e).date.getTime() < 12096e5
                )),
              0 === i.length)
            )
              return new o();
            ...
            return (
              await this.client.api.channels[this.id].messages[
                "bulk-delete"
              ].post({ data: { messages: i } }),
              i.reduce(
                (e, t) =>
                  e.set(
                    t,
    ...
    function (e, t, i) {
      ...
      e.exports = class MessageManager extends s {
        constructor(e, t) {
          super(e.client, t, n, o, e.client.options.messageCacheMaxSize),
            (this.channel = e);
        }
        add(e, t) {
        ...
        fetchPinned(e = !0) {
          return this.client.api.channels[this.channel.id].pins
            .get()
            .then((t) => {
              const i = new r();
        ...
        async _fetchId(e, t) {
          ...
          const s = await this.client.api.channels[this.channel.id].messages[
            e
          ].get();
          return this.add(s, t);
        }
        async _fetchMany(e = {}, t) {
          const i = await this.client.api.channels[
              this.channel.id
            ].messages.get({ query: e }),
            s = new r();
    ...
    function (e, t, i) {
        ...
        e.exports = class BaseClient extends n {
          constructor(e = {}) {
            super(),
              ...
              (this.options = a.mergeDefault(o, e)),
              (this.rest = new r(this, e._tokenType));
          }
          get api() {
      ...
      }.call(this, i(38).setImmediate, i(38).clearImmediate));
    },
    function (e, t, i) {
      (function (e) {
        var s =
    ...
    function (e, t, i) {
      ...
      class DMChannel extends s {
        ...
        _patch(e) {
          super._patch(e),
            e.recipients &&
              (this.recipient = this.client.users.add(e.recipients[0])),
            (this.lastMessageID = e.last_message_id),
            (this.lastPinTimestamp = e.last_pin_timestamp
              ? new Date(e.last_pin_timestamp).getTime()
              : null);
        }
        get partial() {
    ...
    function (e, t, i) {
      ...
      e.exports = class BaseGuildEmoji extends s {
        constructor(e, t, i) {
          super(e, t),
            (this.guild = i),
            Object.defineProperty(this, "_roles", { value: [], writable: !0 }),
            this._patch(t);
        }
        _patch(e) {
          e.name && (this.name = e.name),
            void 0 !== e.require_colons &&
              (this.requiresColons = e.require_colons),
            void 0 !== e.managed && (this.managed = e.managed),
      ...
      class TextChannel extends s {
        ...
        async createWebhook(e, { avatar: t, reason: i } = {}) {
          return (
            "string" != typeof t ||
              t.startsWith("data:") ||
              (t = await c.resolveImage(t)),
            this.client.api.channels[this.id].webhooks
              .post({ data: { name: e, avatar: t }, reason: i })
              .then((e) => new n(this.client, e))
          );
        }
        get lastMessage() {}
    ...
    function (e, t, i) {
      ...
      e.exports = class PermissionOverwrites {
        ...
        _patch(e) {
          (this.id = e.id),
            (this.type = e.type),
            (this.deny = new r(e.deny).freeze()),
            (this.allow = new r(e.allow).freeze());
        }
        update(e, t) {
          const {
            allow: i,
        ...
        delete(e) {
          return this.channel.client.api.channels[this.channel.id].permissions[
            this.id
          ]
            .delete({ reason: e })
            .then(() => this);
        ...
        static resolveOverwriteOptions(e, { allow: t, deny: i } = {}) {
          ...
          for (const [s, n] of Object.entries(e))
            !0 === n
              ? (t.add(r.FLAGS[s]), i.remove(r.FLAGS[s]))
              : !1 === n
              ? (t.remove(r.FLAGS[s]), i.add(r.FLAGS[s]))
              : null === n && (t.remove(r.FLAGS[s]), i.remove(r.FLAGS[s]));
          return { allow: t, deny: i };
        }
        static resolve(e, t) {
          if (e instanceof this) return e.toJSON();
          if ("string" == typeof e.id && ["role", "member"].includes(e.type))
            return { ...e, allow: r.resolve(e.allow), deny: r.resolve(e.deny) };
          const i = t.roles.resolve(e.id) || t.client.users.resolve(e.id);
          if (!i)
            throw new n("INVALID_TYPE", "parameter", "User nor a Role", !0);
      ...
      e.exports = class MessageAttachment {
        ...
        _patch(e) {
          (this.id = e.id),
            ...
            (this.height = void 0 !== e.height ? e.height : null),
            (this.width = void 0 !== e.width ? e.width : null);
        }
        get spoiler() {
      ...
      e.exports = class MessageEmbed {
        ...
        setup(e, t) {
          (this.type = e.type),
            ...
            (this.url = e.url),
            (this.color = n.resolveColor(e.color)),
            ...
            e.fields &&
              (this.fields = t
                ? e.fields.map(n.cloneObject)
                : this.constructor.normalizeFields(e.fields)),
            ...
            (this.author = e.author
              ? {
                  ...
                  proxyIconURL:
                    e.author.proxyIconURL || e.author.proxy_icon_url,
                }
              : null),
            (this.provider = e.provider
              ? { name: e.provider.name, url: e.provider.name }
              : null),
            (this.footer = e.footer
              ? {
                  ...
                  proxyIconURL:
                    e.footer.proxyIconURL || e.footer.proxy_icon_url,
                }
              : null),
            (this.files = e.files || []);
        }
        ...
        get length() {
          return (
            ...
            (this.fields.length >= 1
              ? this.fields.reduce(
                  (e, t) => e + t.name.length + t.value.length,
                  0
                )
              : 0) +
        ...
        spliceFields(e, t, ...i) {
          return (
            this.fields.splice(e, t, ...this.constructor.normalizeFields(...i)),
            this
          );
        }
        attachFiles(e) {
        ...
        setAuthor(e, t, i) {
          return (
            (this.author = { name: n.resolveString(e), iconURL: t, url: i }),
            this
          );
        }
        setColor(e) {
        ...
        setTimestamp(e = Date.now()) {
          return (
            e instanceof Date && (e = e.getTime()), (this.timestamp = e), this
          );
        }
        setTitle(e) {
          ...
          return e
            ...
            .map((e) =>
              this.normalizeField(
                e && e.name,
                e && e.value,
                !(!e || "boolean" != typeof e.inline) && e.inline
              )
            );
        }
      };
    ...
    function (e, t, i) {
      ...
      (function (t, s, n) {
        ...
        var a,
          c =
            !t.browser && ["v0.10", "v0.9."].indexOf(t.version.slice(0, 5)) > -1
              ...
              : r.nextTick;
        _.WritableState = E;
        var l = Object.create(i(25));
        l.inherits = i(22);
        var h = { deprecate: i(126) },
          u = i(66),
          d = i(32).Buffer,
        ...
        function E(e, t) {
          ...
          (this.highWaterMark = n || 0 === n ? n : s && (l || 0 === l) ? l : h),
        ...
        function _(e) {
          if (((a = a || i(20)), !(f.call(_, this) || this instanceof a)))
            return new _(e);
          (this._writableState = new E(e, this)),
            (this.writable = !0),
            e &&
        ...
        function v(e, t) {
          ...
          if (e._writev && i && i.next) {
            ...
            r.entry = i;
            for (var a = 0, c = !0; i; )
              (n[a] = i), i.isBuf || (c = !1), (i = i.next), (a += 1);
            (n.allBuffers = c),
              y(e, t, !0, t.length, n, "", r.finish),
              t.pendingcb++,
            ...
            for (; i; ) {
              var l = i.chunk,
                ...
                u = i.callback;
              if (
                (y(e, t, !1, t.objectMode ? 1 : l.length, l, h, u),
                (i = i.next),
        ...
        l.inherits(_, u),
            ...
            ? ((f = Function.prototype[Symbol.hasInstance]),
              Object.defineProperty(_, Symbol.hasInstance, {
                value: function (e) {
                  return (
                    !!f.call(this, e) ||
                    (this === _ && e && e._writableState instanceof E)
                  );
                },
              }))
            : (f = function (e) {
          ...
          (_.prototype.write = function (e, t, i) {
            var s,
              ...
              o = !1,
              a = !n.objectMode && ((s = e), d.isBuffer(s) || s instanceof p);
            return (
              a &&
                !d.isBuffer(e) &&
                (e = (function (e) {
                ...
                : (a ||
                    (function (e, t, i, s) {
                      ...
                      return (
                        ...
                        o && (e.emit("error", o), r.nextTick(s, o), (n = !1)),
                        n
                      );
                    })(this, n, e, i)) &&
                  (n.pendingcb++,
                  (o = (function (e, t, i, s, n, r) {
                    if (!i) {
      ...
      }.call(this, i(14), i(38).setImmediate, i(21)));
    },
    function (e, t, i) {
      "use strict";
      const s = i(11);
    ...
    function (e, t, i) {
      ...
      i(12).applyToClass(WebhookClient), (e.exports = WebhookClient);
    },
    function (e, t, i) {
      "use strict";
      const s = i(15),
        n = i(2),
        r = i(4);
      e.exports = class Collector extends s {
        constructor(e, t, i = {}) {
          super(),
            Object.defineProperty(this, "client", { value: e }),
            (this.filter = t),
            (this.options = i),
            (this.collected = new n()),
            (this.ended = !1),
            (this._timeout = null),
            ...
            i.idle &&
              (this._idletimeout = this.client.setTimeout(
                () => this.stop("idle"),
                i.idle
              ));
        }
        ...
        stop(e = "user") {
          this.ended ||
            (this._timeout &&
              (this.client.clearTimeout(this._timeout), (this._timeout = null)),
            this._idletimeout &&
              (this.client.clearTimeout(this._idletimeout),
              (this._idletimeout = null)),
            (this.ended = !0),
    ...
    function (e, t, i) {
      ...
      const s = i(5),
        n = i(73),
        { ClientApplicationAssetTypes: r, Endpoints: o } = i(0),
        a = i(7),
        c = Object.keys(r);
      e.exports = class ClientApplication extends s {
        ...
        _patch(e) {
          (this.id = e.id),
            ...
            (this.description = e.description),
            (this.icon = e.icon),
            (this.cover = e.cover_image || null),
            (this.rpcOrigins = e.rpc_origins || []),
            (this.botRequireCodeGrant =
              void 0 !== e.bot_require_code_grant
                ? e.bot_require_code_grant
                : null),
            (this.botPublic = void 0 !== e.bot_public ? e.bot_public : null),
            (this.owner = e.team
              ? new n(this.client, e.team)
              : e.owner
              ? this.client.users.add(e.owner)
              : null);
        }
        get createdTimestamp() {
          return a.deconstruct(this.id).timestamp;
        ...
        iconURL({ format: e, size: t } = {}) {
          return this.icon
            ? this.client.rest.cdn.AppIcon(this.id, this.icon, {
                format: e,
                size: t,
              })
            : null;
        ...
        coverImage({ format: e, size: t } = {}) {
          return this.cover
            ? o
                ...
                .AppIcon(this.id, this.cover, { format: e, size: t })
            : null;
        }
        fetchAssets() {
          return this.client.api.oauth2
            ...
            .assets.get()
            .then((e) =>
              e.map((e) => ({ id: e.id, name: e.name, type: c[e.type - 1] }))
            );
        }
        toString() {
          return this.name;
      ...
      e.exports = class MessageReaction {
        constructor(e, t, i) {
          Object.defineProperty(this, "client", { value: e }),
            (this.message = i),
            (this.me = t.me),
            (this.users = new r(e, void 0, this)),
            (this._emoji = new n(this, t.emoji)),
            this._patch(t);
        }
        _patch(e) {
        ...
        async fetch() {
          const e = (await this.message.fetch()).reactions.cache.get(
        ...
        _add(e) {
          this.partial ||
            ...
            (this.me &&
              ...
              0 !== this.count) ||
              this.count++,
            this.me || (this.me = e.id === this.message.client.user.id));
        }
        _remove(e) {
          this.partial ||
            (this.users.cache.delete(e.id),
            (this.me && e.id === this.message.client.user.id) || this.count--,
            e.id === this.message.client.user.id && (this.me = !1),
            this.count <= 0 &&
              0 === this.users.cache.size &&
    ...
    function (e, t, i) {
      ...
      const s = i(5),
        ...
        g = i(2),
        {
          ...
          PartialTypes: y,
          VerificationLevels: b,
          ExplicitContentFilterLevels: v,
        } = i(0),
        w = i(9),
        A = i(7),
        S = i(88),
        I = i(4);
      e.exports = class Guild extends s {
        constructor(e, t) {
          super(e),
            (this.members = new d(this)),
            (this.channels = new h(this)),
            (this.roles = new f(this)),
            (this.presences = new p(this.client)),
            (this.voiceStates = new m(this)),
            (this.deleted = !1),
            t &&
              (t.unavailable
                ? ((this.available = !1), (this.id = t.id))
                : (this._patch(t), t.channels || (this.available = !1)),
        ...
        _patch(e) {
          if (
            ...
            void 0 !== e.premium_subscription_count &&
              (this.premiumSubscriptionCount = e.premium_subscription_count),
            void 0 !== e.widget_enabled &&
              (this.widgetEnabled = e.widget_enabled),
            void 0 !== e.widget_channel_id &&
              (this.widgetChannelID = e.widget_channel_id),
            void 0 !== e.embed_channel_id &&
              (this.embedChannelID = e.embed_channel_id),
            (this.verificationLevel = b[e.verification_level]),
            (this.explicitContentFilter = v[e.explicit_content_filter]),
            (this.mfaLevel = e.mfa_level),
            (this.joinedTimestamp = e.joined_at
              ? new Date(e.joined_at).getTime()
              : this.joinedTimestamp),
            (this.defaultMessageNotifications =
              _[e.default_message_notifications] ||
              e.default_message_notifications),
            (this.systemChannelFlags = new S(e.system_channel_flags).freeze()),
            void 0 !== e.max_members &&
              (this.maximumMembers = e.max_members || 25e4),
            void 0 !== e.max_presences &&
              (this.maximumPresences = e.max_presences || 25e3),
          ...
          if ((e.owner_id && (this.ownerID = e.owner_id), e.presences))
            for (const t of e.presences)
              this.presences.add(Object.assign(t, { guild: this }));
          if (e.voice_states) {
        ...
        bannerURL({ format: e, size: t } = {}) {
          return this.banner
            ? this.client.rest.cdn.Banner(this.id, this.banner, e, t)
            : null;
        }
        get createdTimestamp() {
          return A.deconstruct(this.id).timestamp;
        ...
        iconURL({ format: e, size: t, dynamic: i } = {}) {
          return this.icon
            ? this.client.rest.cdn.Icon(this.id, this.icon, e, t, i)
            : null;
        }
        get nameAcronym() {
        ...
        splashURL({ format: e, size: t } = {}) {
          return this.splash
            ? this.client.rest.cdn.Splash(this.id, this.splash, e, t)
            : null;
        }
        get owner() {
          return (
            this.members.cache.get(this.ownerID) ||
            (this.client.options.partials.includes(y.GUILD_MEMBER)
              ? this.members.add({ user: { id: this.ownerID } }, !0)
              : null)
          );
        }
        get afkChannel() {
        ...
        get publicUpdatesChannel() {
          return (
            this.client.channels.cache.get(this.publicUpdatesChannelID) || null
          );
        }
        get me() {
          return (
            ...
            (this.client.options.partials.includes(y.GUILD_MEMBER)
              ? this.members.add({ user: { id: this.client.user.id } }, !0)
              : null)
          );
        }
        get voice() {
        ...
        fetchIntegrations() {
          return this.client.api
            ...
            .then((e) =>
              e.reduce(
                (e, t) => e.set(t.id, new o(this.client, t, this)),
                new g()
              )
            );
        }
        createIntegration(e, t) {
          return this.client.api
            .guilds(this.id)
            .integrations.post({ data: e, reason: t })
            .then(() => this);
        }
        fetchInvites() {
          return this.client.api
        ...
        fetchVanityCode() {
          return this.features.includes("VANITY_URL")
            ? this.client.api
                ...
                .get()
                .then((e) => e.code)
            : Promise.reject(new Error("VANITY_URL"));
        }
        fetchWebhooks() {
          return this.client.api
            .guilds(this.id)
            ...
            .then((e) => {
              const t = new g();
              for (const i of e) t.set(i.id, new l(this.client, i));
              return t;
            });
        }
        fetchVoiceRegions() {
          return this.client.api
            ...
            .then((e) => {
              const t = new g();
              for (const i of e) t.set(i.id, new c(i));
              return t;
            });
        }
        fetchEmbed() {
        ...
        fetchAuditLogs(e = {}) {
          return (
            e.before && e.before instanceof n.Entry && (e.before = e.before.id),
            "string" == typeof e.type && (e.type = n.Actions[e.type]),
            this.client.api
              .guilds(this.id)
              ["audit-logs"].get({
                query: {
        ...
        addMember(e, t) {
          if (!(e = this.client.users.resolveID(e)))
            return Promise.reject(
              new TypeError("INVALID_TYPE", "user", "UserResolvable")
            );
          if (this.members.cache.has(e))
            return Promise.resolve(this.members.cache.get(e));
          if (((t.access_token = t.accessToken), t.roles)) {
            const e = [];
            for (let i of t.roles instanceof g ? t.roles.values() : t.roles) {
              if (((i = this.roles.resolve(i)), !i))
                return Promise.reject(
                  new TypeError(
                    "INVALID_TYPE",
                    "options.roles",
          ...
          return (
            ...
            void 0 !== e.verificationLevel &&
              (i.verification_level =
                "number" == typeof e.verificationLevel
                  ? Number(e.verificationLevel)
                  : b.indexOf(e.verificationLevel)),
            void 0 !== e.afkChannel &&
              (i.afk_channel_id = this.client.channels.resolveID(e.afkChannel)),
            void 0 !== e.systemChannel &&
              (i.system_channel_id = this.client.channels.resolveID(
                e.systemChannel
              )),
            e.afkTimeout && (i.afk_timeout = Number(e.afkTimeout)),
            void 0 !== e.icon && (i.icon = e.icon),
            e.owner && (i.owner_id = this.client.users.resolveID(e.owner)),
            e.splash && (i.splash = e.splash),
            e.banner && (i.banner = e.banner),
            void 0 !== e.explicitContentFilter &&
              (i.explicit_content_filter =
                "number" == typeof e.explicitContentFilter
                  ? e.explicitContentFilter
                  : v.indexOf(e.explicitContentFilter)),
            void 0 !== e.defaultMessageNotifications &&
              (i.default_message_notifications =
                "string" == typeof e.defaultMessageNotifications
                  ? _.indexOf(e.defaultMessageNotifications)
                  : e.defaultMessageNotifications),
            void 0 !== e.systemChannelFlags &&
              (i.system_channel_flags = S.resolve(e.systemChannelFlags)),
            this.client.api
              .guilds(this.id)
              .patch({ data: i, reason: t })
        ...
        async setIcon(e, t) {
          return this.edit({ icon: await w.resolveImage(e), reason: t });
        }
        setOwner(e, t) {
          return this.edit({ owner: e }, t);
        }
        async setSplash(e, t) {
          return this.edit({ splash: await w.resolveImage(e), reason: t });
        }
        async setBanner(e, t) {
          return this.edit({ banner: await w.resolveImage(e), reason: t });
        }
        ...
        leave() {
          return this.ownerID === this.client.user.id
            ? Promise.reject(new Error("GUILD_OWNED"))
            : this.client.api
                .users("@me")
                .guilds(this.id)
                .delete()
        ...
        delete() {
          return this.client.api
            ...
            .then(
              () =>
                this.client.actions.GuildDelete.handle({ id: this.id }).guild
            );
        }
        equals(e) {
          let t =
            ...
            this.embedEnabled === e.embedEnabled &&
            (this.features === e.features ||
          ...
          return (
            t &&
              (this.embedChannel
                ? (e.embedChannel &&
                    this.embedChannel.id === e.embedChannel.id) ||
                  (t = !1)
                : e.embedChannel && (t = !1)),
            t
          );
        ...
        _sortedRoles() {
          return I.discordSort(this.roles.cache);
        }
        _sortedChannels(e) {
          const t = e.type === E.CATEGORY;
          return I.discordSort(
            this.channels.cache.filter(
              (i) =>
                (["text", "news", "store"].includes(e.type)
                  ? ["text", "news", "store"].includes(i.type)
                  : i.type === e.type) &&
                (t || i.parent === e.parent)
            )
          );
      ...
      e.exports = class Integration extends s {
        constructor(e, t, i) {
          super(e),
            ...
            (this.role = this.guild.roles.cache.get(t.role_id)),
            (this.user = this.client.users.add(t.user)),
            (this.account = t.account),
            (this.syncedAt = t.synced_at),
            this._patch(t);
        }
        _patch(e) {
        ...
        sync() {
          return (
            ...
            this.client.api
              ...
              .post()
              .then(
                () => ((this.syncing = !1), (this.syncedAt = Date.now()), this)
              )
          );
        }
        edit(e, t) {
          return (
            "expireBehavior" in e &&
              ((e.expire_behavior = e.expireBehavior),
              (e.expireBehavior = null)),
            "expireGracePeriod" in e &&
              ((e.expire_grace_period = e.expireGracePeriod),
              (e.expireGracePeriod = null)),
            this.client.api
              .guilds(this.guild.id)
              .integrations(this.id)
              .patch({ data: e, reason: t })
      ...
      e.exports = class GuildPreview extends s {
        ...
        _patch(e) {
          (this.id = e.id),
            ...
            (this.description = e.description),
            this.emojis ? this.emojis.clear() : (this.emojis = new r());
          for (const t of e.emojis)
            this.emojis.set(t.id, new n(this.client, t, this));
        }
        splashURL({ format: e, size: t } = {}) {
          return this.splash
            ? this.client.rest.cdn.Splash(this.id, this.splash, e, t)
        ...
        toJSON() {
          const e = super.toJSON();
          return (
            (e.iconURL = this.iconURL()), (e.splashURL = this.splashURL()), e
          );
        }
      };
    },
        ...
        async create(e, t, { roles: i, reason: s } = {}) {
          ...
          if (i) {
            ...
            for (let e of i instanceof a ? i.values() : i) {
              if (((e = this.guild.roles.resolve(e)), !e))
                return Promise.reject(
                  new n(
                    "INVALID_TYPE",
                    "options.roles",
          ...
          return this.client.api
            .guilds(this.guild.id)
            .emojis.post({ data: r, reason: s })
            .then(
              (e) =>
                this.client.actions.GuildEmojiCreate.handle(this.guild, e).emoji
            );
        }
        resolve(e) {
          ...
          constructor(e, ...t) {
            super(
              (function (e, t) {
                ...
                if (!i)
                  throw new Error(
                    `An invalid error message key was used: ${e}.`
                  );
                return "function" == typeof i
                  ? i(...t)
                  : void 0 === t || 0 === t.length
                  ? i
                  : (t.unshift(i), String(...t));
              })(e, t)
            ),
              (this[s] = e),
      ...
      class DiscordAPIError extends Error {
        ...
        static flattenErrors(e, t = "") {
          ...
          for (const [s, n] of Object.entries(e)) {
            ...
            n._errors
              ? i.push(`${e}: ${n._errors.map((e) => e.message).join(" ")}`)
              : n.code || n.message
              ? i.push(`${n.code ? `${n.code}: ` : ""}${n.message}`.trim())
              : "string" == typeof n
              ? i.push(n)
              : (i = i.concat(this.flattenErrors(n, e)));
          }
          return i;
        }
      }
    ...
    function (e, t, i) {
      ...
      e.exports = class GuildEmojiRoleManager {
        ...
        add(e) {
          ...
          if ((e = e.map((e) => this.guild.roles.resolve(e))).includes(null))
            return Promise.reject(
              new s(
                "INVALID_TYPE",
                "roles",
        ...
        remove(e) {
          ...
          if ((e = e.map((e) => this.guild.roles.resolveID(e))).includes(null))
            return Promise.reject(
              new s(
                "INVALID_TYPE",
                "roles",
    ...
    function (e, t, i) {
      ...
      (function (t, s) {
        ...
        function _(e, t) {
          ...
          (this.highWaterMark = n || 0 === n ? n : s && (o || 0 === o) ? o : a),
            (this.highWaterMark = Math.floor(this.highWaterMark)),
            (this.buffer = new m()),
            (this.length = 0),
            (this.pipes = null),
        ...
        function v(e, t, i, s) {
          t.flowing && 0 === t.length && !t.sync
            ...
            : ((t.length += t.objectMode ? 1 : i.length),
              s ? t.buffer.unshift(i) : t.buffer.push(i),
              t.needReadable && A(e)),
            I(e, t);
        }
        ...
        function T(e, t) {
          for (
            ...
            (p("maybeReadMore read 0"), e.read(0), i !== t.length);
        ...
        (y.prototype.read = function (e) {
          ...
          if (
            ...
            return (
              ...
              0 === t.length && t.ended ? C(this) : A(this),
              null
            );
          ...
          return (
            ...
            (0 === t.length || t.length - e < t.highWaterMark) &&
              p("length less than watermark", (n = !0)),
            t.ended || t.reading
              ...
              : n &&
                ...
                (t.sync = !1),
                t.reading || (e = w(i, t))),
            null === (s = e > 0 ? O(e, t) : null)
              ? ((t.needReadable = !0), (e = 0))
              : (t.length -= e),
            0 === t.length &&
              (t.ended || (t.needReadable = !0), i !== e && t.ended && C(this)),
          ...
          (y.prototype.pipe = function (e, t) {
            ...
            var c =
              (!t || !1 !== t.end) && e !== s.stdout && e !== s.stderr ? h : y;
            function l(t, s) {
              p("onunpipe"),
                t === i &&
                  s &&
            ...
            return (
              ...
              e.once("finish", _),
              e.emit("pipe", i),
              r.flowing || (p("pipe resume"), i.resume()),
              e
            );
          }),
          ...
          (y.prototype.on = function (e, t) {
            ...
            if ("data" === e)
              ...
              s.endEmitted ||
                ...
                (s.emittedReadable = !1),
                s.reading ? s.length && A(this) : n.nextTick(D, this));
            }
            return i;
          }),
          ...
          (y.prototype.wrap = function (e) {
            ...
            for (var r = 0; r < E.length; r++)
              e.on(E[r], this.emit.bind(this, E[r]));
            return (
      ...
      function r(e) {
        ...
        switch (
          ((this.encoding = (function (e) {
            ...
            if ("string" != typeof t && (s.isEncoding === n || !n(e)))
      ...
      (n.inherits = i(22)),
        ...
        (o.prototype._write = function (e, t, i) {
          ...
          if (
            ...
            var n = this._readableState;
            (s.needTransform || n.needReadable || n.length < n.highWaterMark) &&
              this._read(n.highWaterMark);
          }
        }),
    ...
    function (e, t, i) {
      ...
      e.exports = class MessageCollector extends s {
        constructor(e, t, i = {}) {
          ...
          (this._handleChannelDeletion = this._handleChannelDeletion.bind(
            this
          )),
            (this._handleGuildDeletion = this._handleGuildDeletion.bind(this)),
            0 !== this.client.getMaxListeners() &&
              this.client.setMaxListeners(this.client.getMaxListeners() + 1),
            this.client.on(n.MESSAGE_CREATE, this.handleCollect),
            this.client.on(n.MESSAGE_DELETE, this.handleDispose),
            this.client.on(n.MESSAGE_BULK_DELETE, s),
            this.client.on(n.CHANNEL_DELETE, this._handleChannelDeletion),
            this.client.on(n.GUILD_DELETE, this._handleGuildDeletion),
            this.once("end", () => {
              this.client.removeListener(n.MESSAGE_CREATE, this.handleCollect),
                this.client.removeListener(
                  n.MESSAGE_DELETE,
                  this.handleDispose
                ),
                this.client.removeListener(n.MESSAGE_BULK_DELETE, s),
                this.client.removeListener(
                  n.CHANNEL_DELETE,
        ...
        endReason() {
          return this.options.max && this.collected.size >= this.options.max
            ? "limit"
    ...
    function (e, t, i) {
      ...
      e.exports = class GuildMemberRoleManager {
        ...
        async add(e, t) {
          ...
          {
            if (null === (e = this.guild.roles.resolve(e)))
              throw new s(
                "INVALID_TYPE",
                "roles",
            ...
            await this.client.api.guilds[this.guild.id].members[
              this.member.id
            ].roles[e.id].put({ reason: t });
    ...
    function (e, t, i) {
      ...
      e.exports = class Team extends s {
        ...
        iconURL({ format: e, size: t } = {}) {
          return this.icon
            ? this.client.rest.cdn.TeamIcon(this.id, this.icon, {
                format: e,
                size: t,
              })
            : null;
      ...
      e.exports = class TeamMember extends s {
        ...
        _patch(e) {
          (this.permissions = e.permissions),
            (this.membershipState = n[e.membership_state]),
            (this.user = this.client.users.add(e.user));
        }
        get id() {
          return this.user.id;
        }
      ...
      class MessageMentions {
        constructor(e, t, i, r, o) {
          if (
            ...
            (this.everyone = Boolean(r)),
            t)
          )
            if (t instanceof s) this.users = new s(t);
            else {
              this.users = new s();
              for (const i of t) {
                i.member &&
                  e.guild &&
                  e.guild.members.add(Object.assign(i.member, { user: i }));
          ...
          if (i)
            if (i instanceof s) this.roles = new s(i);
            else {
              this.roles = new s();
              for (const t of i) {
          ...
          if (((this._members = null), (this._channels = null), o))
            if (o instanceof s) this.crosspostedChannels = new s(o);
            else {
        ...
        get channels() {
          ...
          for (
            ...
            null !==
            (e = this.constructor.CHANNELS_PATTERN.exec(this._content));
        ...
        has(
          ...
          if (!t) {
            const t = e.id || e;
            return (
              this.users.has(t) || this.channels.has(t) || this.roles.has(t)
            );
          }
          return !1;
        }
      ...
      class ReactionCollector extends s {
        constructor(e, t, i = {}) {
          super(e.client, t, i),
            ...
            (this._handleGuildDeletion = this._handleGuildDeletion.bind(this)),
            (this._handleMessageDeletion = this._handleMessageDeletion.bind(
              this
            )),
            0 !== this.client.getMaxListeners() &&
              this.client.setMaxListeners(this.client.getMaxListeners() + 1),
            this.client.on(r.MESSAGE_REACTION_ADD, this.handleCollect),
            this.client.on(r.MESSAGE_REACTION_REMOVE, this.handleDispose),
            this.client.on(r.MESSAGE_REACTION_REMOVE_ALL, this.empty),
            this.client.on(r.MESSAGE_DELETE, this._handleMessageDeletion),
            this.client.on(r.CHANNEL_DELETE, this._handleChannelDeletion),
            this.client.on(r.GUILD_DELETE, this._handleGuildDeletion),
            this.once("end", () => {
              this.client.removeListener(
                r.MESSAGE_REACTION_ADD,
                this.handleCollect
              ),
                this.client.removeListener(
                  r.MESSAGE_REACTION_REMOVE,
                  this.handleDispose
                ),
                this.client.removeListener(
                  r.MESSAGE_REACTION_REMOVE_ALL,
                  this.empty
                ),
                this.client.removeListener(
                  r.MESSAGE_DELETE,
            ...
            this.on("remove", (e, t) => {
              this.total--,
                this.collected.some((e) => e.users.cache.has(t.id)) ||
        ...
        dispose(e, t) {
          return e.message.id !== this.message.id
            ...
            : (this.collected.has(ReactionCollector.key(e)) &&
              ...
              e.count ? null : ReactionCollector.key(e));
        }
        empty() {
          (this.total = 0),
        ...
        endReason() {
          return this.options.max && this.total >= this.options.max
            ? "limit"
      ...
      e.exports = class ReactionUserManager extends s {
        ...
        async fetch({ limit: e = 100, after: t, before: i } = {}) {
          const s = this.reaction.message,
            n = await this.client.api.channels[s.channel.id].messages[
              s.id
            ].reactions[this.reaction.emoji.identifier].get({
              query: { limit: e, before: i, after: t },
            }),
            o = new r();
          for (const e of n) {
        ...
        remove(e = this.reaction.message.client.user) {
          const t = this.reaction.message,
            i = t.client.users.resolveID(e);
          return i
            ? t.client.api.channels[t.channel.id].messages[t.id].reactions[
                this.reaction.emoji.identifier
              ][i === t.client.user.id ? "@me" : i]
                .delete()
                .then(() => this.reaction)
            : Promise.reject(new n("REACTION_RESOLVE_USER"));
        }
      };
    },
    function (e, t, i) {
      ...
      e.exports = class VoiceChannel extends s {
        ...
        get members() {
          ...
          for (const t of this.guild.voiceStates.cache.values())
            t.channelID === this.id && t.member && e.set(t.id, t.member);
          return e;
        }
        get full() {
        ...
        get deletable() {
          return (
            super.deletable &&
            this.permissionsFor(this.client.user).has(a.FLAGS.CONNECT, !1)
          );
        }
        get editable() {
          return (
        ...
        join() {
          return o
            ? Promise.reject(new n("VOICE_NO_BROWSER"))
    ...
    function (e, t, i) {
      ...
      class GuildAuditLogs {
        constructor(e, t) {
          ...
          if (((this.webhooks = new r()), t.webhooks))
            for (const i of t.webhooks)
              this.webhooks.set(i.id, new n(e.client, i));
          if (((this.integrations = new r()), t.integrations))
            for (const i of t.integrations)
              this.integrations.set(i.id, new s(e.client, i, e));
          this.entries = new r();
        ...
        static actionType(e) {
          return [
            ...
            h.EMOJI_CREATE,
            h.MESSAGE_PIN,
            h.INTEGRATION_CREATE,
          ].includes(e)
            ? "CREATE"
            : [
                h.CHANNEL_DELETE,
                h.CHANNEL_OVERWRITE_DELETE,
                h.MEMBER_KICK,
                h.MEMBER_PRUNE,
                h.MEMBER_BAN_ADD,
                h.MEMBER_DISCONNECT,
                ...
                h.EMOJI_DELETE,
                h.MESSAGE_DELETE,
                h.MESSAGE_BULK_DELETE,
                h.MESSAGE_UNPIN,
                h.INTEGRATION_DELETE,
              ].includes(e)
            ? "DELETE"
            : [
                h.GUILD_UPDATE,
                h.CHANNEL_UPDATE,
                h.CHANNEL_OVERWRITE_UPDATE,
                h.MEMBER_UPDATE,
                h.MEMBER_ROLE_UPDATE,
                h.MEMBER_MOVE,
                h.ROLE_UPDATE,
                h.INVITE_UPDATE,
                h.WEBHOOK_UPDATE,
                h.EMOJI_UPDATE,
                h.INTEGRATION_UPDATE,
              ].includes(e)
            ? "UPDATE"
            : "ALL";
        }
      ...
      class GuildAuditLogsEntry {
        constructor(e, t, i) {
          ...
          switch (
            ((this.targetType = r),
            (this.actionType = GuildAuditLogs.actionType(i.action_type)),
            (this.action = Object.keys(h).find((e) => h[e] === i.action_type)),
            (this.reason = i.reason || null),
            (this.executor = t.client.options.partials.includes(o.USER)
              ? t.client.users.add({ id: i.user_id })
              : t.client.users.cache.get(i.user_id)),
            (this.changes = i.changes
              ? i.changes.map((e) => ({
                  key: e.key,
                  old: e.old_value,
                  new: e.new_value,
          ...
          (this.target = null),
            r === l.UNKNOWN
              ...
              : r === l.USER && i.target_id
              ? (this.target = t.client.options.partials.includes(o.USER)
                  ? t.client.users.add({ id: i.target_id })
              ...
              : r === l.INVITE
              ? (this.target = t.members.fetch(t.client.user.id).then((e) => {
              ...
              : r === l.MESSAGE
              ? (this.target =
                  i.action_type === h.MESSAGE_BULK_DELETE
              ...
              : i.target_id &&
                (this.target = t[`${r.toLowerCase()}s`].cache.get(
                  i.target_id
                ) || { id: i.target_id });
        }
        get createdTimestamp() {
      ...
      (GuildAuditLogs.Actions = h),
        (GuildAuditLogs.Targets = l),
    ...
    function (e, t, i) {
      ...
      e.exports = class GuildChannelManager extends s {
        ...
        async create(e, t = {}) {
          ...
          l && (l = this.client.channels.resolveID(l)),
            h && (h = h.map((e) => r.resolve(e, this.guild)));
          const f = await this.client.api
            .guilds(this.guild.id)
            .channels.post({
              data: {
                name: e,
      ...
      e.exports = class GuildMemberManager extends s {
        ...
        fetch(e) {
          ...
          if (e.user) {
            ...
            if (
              ...
              !e.limit && !e.withPresences)
            )
              return this._fetchSingle(e);
          }
        ...
        prune({ days: e = 7, dry: t = !1, count: i = !0, reason: s } = {}) {
          ...
          return this.client.api
            .guilds(this.guild.id)
            .prune[t ? "get" : "post"]({
              query: { days: e, compute_prune_count: i },
              reason: s,
            })
            .then((e) => e.pruned);
        }
        ...
        unban(e, t) {
          ...
          return i
            ? this.client.api
                .guilds(this.guild.id)
                .bans[i].delete({ reason: t })
                .then(() => this.client.users.resolve(e))
            : Promise.reject(new n("BAN_RESOLVE_ID"));
        }
        ...
        _fetchMany({
          ...
          return new Promise((o, h) => {
            if (
              !(this.guild.memberCount !== this.cache.size || s || e || t || i)
            )
              return void o(this.cache);
            s || i || (s = ""),
            ...
            const u = new a(),
              d = s || e || t || i,
              p = (t, s) => {
                if (s.id === this.guild.id) {
                  f.refresh();
                  for (const e of t.values()) d && u.set(e.id, e);
                  if (
                    this.guild.memberCount <= this.cache.size ||
                    (d && t.size < 1e3) ||
                    (e && u.size >= e)
                  ) {
                    this.guild.client.removeListener(c.GUILD_MEMBERS_CHUNK, p);
                    let e = d ? u : this.cache;
                    i && !Array.isArray(i) && e.size && (e = e.first()), o(e);
                  }
                }
              },
              f = this.guild.client.setTimeout(() => {
                this.guild.client.removeListener(c.GUILD_MEMBERS_CHUNK, p),
                  h(new n("GUILD_MEMBERS_TIMEOUT"));
              }, r);
            this.guild.client.on(c.GUILD_MEMBERS_CHUNK, p);
          });
        }
      };
    },
    ...
    function (e, t, i) {
      ...
      e.exports = class RoleManager extends s {
        ...
        create({ data: e = {}, reason: t } = {}) {
          return (
            e.color && (e.color = o(e.color)),
            e.permissions && (e.permissions = r.resolve(e.permissions)),
            this.guild.client.api
              .guilds(this.guild.id)
              .roles.post({ data: e, reason: t })
              .then((i) => {
                const { role: s } = this.client.actions.GuildRoleCreate.handle({
                  guild_id: this.guild.id,
                  role: i,
                });
    ...
    function (e, t, i) {
      "use strict";
      const { Presence: s } = i(13),
        { TypeError: n } = i(3),
        r = i(2),
        { ActivityTypes: o, OPCodes: a } = i(0);
      e.exports = class ClientPresence extends s {
        ...
        async set(e) {
          ...
          if ((this.patch(t), void 0 === e.shardID))
            this.client.ws.broadcast({ op: a.STATUS_UPDATE, d: t });
          else if (Array.isArray(e.shardID))
            for (const i of e.shardID)
              this.client.ws.shards.get(i).send({ op: a.STATUS_UPDATE, d: t });
          else
            this.client.ws.shards
              .get(e.shardID)
              .send({ op: a.STATUS_UPDATE, d: t });
          return this;
        }
        async _parse({ status: e, since: t, afk: i, activity: s }) {
          const a =
            s && (s.application ? s.application.id || s.application : null);
          let c = new r();
          if (s) {
            if ("string" != typeof s.name)
              throw new n("INVALID_TYPE", "name", "string");
            if ((s.type || (s.type = 0), s.assets && a))
              try {
                const e = await this.client.api.oauth2
                  .applications(a)
                  .assets.get();
              ...
              ? {
                  ...
                  assets: s.assets
                    ? {
                        ...
                        large_image:
                          c.get(s.assets.largeImage) || s.assets.largeImage,
                        small_image:
                          c.get(s.assets.smallImage) || s.assets.smallImage,
                      }
                    : void 0,
          ...
          return (
            (e || i || t) && !s && (l.game = this.activities[0] || null),
            l.game &&
              (l.game.type =
                "number" == typeof l.game.type
                  ? l.game.type
                  : o.indexOf(l.game.type)),
            l
          );
        }
      };
    ...
    function (e, t, i) {
      ...
      let n, r;
      try {
        (n = i(161)), n.pack || (n = null);
      } catch {}
      s
        ? ((r = window.TextDecoder), (t.WebSocket = window.WebSocket))
        : ((r = i(162).TextDecoder), (t.WebSocket = i(165)));
      const o = new r();
      (t.encoding = n ? "etf" : "json"),
        (t.pack = n ? n.pack : JSON.stringify),
        (t.unpack = (e, i) =>
          "json" === t.encoding || "json" === i
            ? ("string" != typeof e && (e = o.decode(e)), JSON.parse(e))
            : (Buffer.isBuffer(e) || (e = Buffer.from(new Uint8Array(e))),
              n.unpack(e))),
        (t.create = (e, i = {}, ...n) => {
          const [r, o] = e.split("?");
          (i.encoding = t.encoding),
            (i = new URLSearchParams(i)),
            o && new URLSearchParams(o).forEach((e, t) => i.set(t, e));
    ...
    function (e, t, i) {
      ...
      class ClientUser extends n.get("User") {
        ...
        _patch(e) {
          super._patch(e),
            "verified" in e && (this.verified = e.verified),
            "mfa_enabled" in e
              ? (this.mfaEnabled =
                  "boolean" == typeof e.mfa_enabled ? e.mfa_enabled : null)
              : void 0 === this.mfaEnabled && (this.mfaEnabled = null),
        ...
        setActivity(e, t = {}) {
          if (!e)
            return this.setPresence({ activity: null, shardID: t.shardID });
      ...
      e.exports = class GuildManager extends s {
        ...
        resolve(e) {
          return e instanceof r ||
            ...
            e instanceof o ||
            e instanceof l ||
            (e instanceof c && e.guild)
            ? super.resolve(e.guild)
            : super.resolve(e);
        }
        resolveID(e) {
          return e instanceof r ||
        ...
        async create(
          ...
          (n = await f.resolveImage(n)),
            void 0 !== a && "number" != typeof a && (a = u.indexOf(a)),
            void 0 !== i && "number" != typeof i && (i = d.indexOf(i)),
            void 0 !== s && "number" != typeof s && (s = p.indexOf(s));
          for (const e of t)
            if (
              ...
              for (const t of e.permissionOverwrites)
                t.allow && (t.allow = m.resolve(t.allow)),
                  t.deny && (t.deny = m.resolve(t.deny));
              (e.permission_overwrites = e.permissionOverwrites),
                delete e.permissionOverwrites;
            }
          for (const e of o)
            e.color && (e.color = g(e.color)),
              e.permissions && (e.permissions = m.resolve(e.permissions));
          return new Promise((c, l) =>
            this.client.api.guilds
              ...
              .then((e) => {
                if (this.client.guilds.cache.has(e.id))
                  return c(this.client.guilds.cache.get(e.id));
                const t = (s) => {
                  s.id === e.id &&
                    (this.client.removeListener(h.GUILD_CREATE, t),
                    this.client.clearTimeout(i),
                    c(s));
                };
                this.client.on(h.GUILD_CREATE, t);
                const i = this.client.setTimeout(() => {
                  this.client.removeListener(h.GUILD_CREATE, t),
                    c(this.client.guilds.add(e));
                }, 1e4);
              }, l)
          );
        }
    ...
    function (e, t, i) {
      ...
      (Intents.FLAGS = {
        ...
        (Intents.ALL = Object.values(Intents.FLAGS).reduce((e, t) => e | t, 0)),
    ...
    function (e, t, i) {
      ...
      e.exports = {
        ...
        SnowflakeUtil: i(7),
        Structures: i(23),
        SystemChannelFlags: i(88),
        UserFlags: i(78),
        Util: s,
        version: i(58).version,
        ChannelManager: i(93),
        GuildChannelManager: i(84),
        GuildEmojiManager: i(57),
        GuildEmojiRoleManager: i(63),
        GuildMemberManager: i(85),
        GuildMemberRoleManager: i(72),
        GuildManager: i(94),
        ReactionUserManager: i(77),
        MessageManager: i(34),
        PresenceManager: i(86),
        RoleManager: i(87),
        UserManager: i(95),
        ...
        Invite: i(18),
        Message: i(28),
        MessageAttachment: i(43),
        MessageCollector: i(71),
        MessageEmbed: i(44),
        MessageMentions: i(75),
        MessageReaction: i(51),
        NewsChannel: i(81),
        PermissionOverwrites: i(42),
        Presence: i(13).Presence,
        ClientPresence: i(89),
        ReactionCollector: i(76),
        ReactionEmoji: i(52),
    ...
    function (e, t, i) {
      ...
      const { register: s } = i(59),
        n = {
          ...
          VOICE_CONNECTION_ATTEMPTS_EXCEEDED: (e) =>
            `Too many connection attempts (${e}).`,
          ...
          VOICE_STATE_UNCACHED_MEMBER:
            "The member of this voice state is uncached.",
          VOICE_STATE_NOT_OWN:
            "You cannot self-deafen/mute on VoiceStates that do not belong to the ClientUser.",
          ...
          INVALID_TYPE: (e, t, i = !1) =>
            `Supplied ${e} is not a${i ? "n" : ""} ${t}.`,
          WEBHOOK_MESSAGE: "The message was not sent by a webhook.",
          EMOJI_TYPE: "Emoji must be a string or GuildEmoji/ReactionEmoji",
          EMOJI_MANAGED: "Emoji is managed and has no Author.",
          MISSING_MANAGE_EMOJIS_PERMISSION: (e) =>
            `Client must have Manage Emoji permission in guild ${e} to see emoji authors.`,
          REACTION_RESOLVE_USER:
            "Couldn't resolve the user ID to remove from the reaction.",
          VANITY_URL:
            "This guild does not have the VANITY_URL feature enabled.",
      ...
      class Collection extends Map {
        ...
        partition(e, t) {
          ...
          for (const [t, s] of this)
            e(s, t, this) ? i[0].set(t, s) : i[1].set(t, s);
          return i;
        }
        flatMap(e, t) {
        ...
        difference(e) {
          return e
            .filter((e, t) => !this.has(t))
            .concat(this.filter((t, i) => !e.has(i)));
        }
        sorted(e = (e, t) => Number(e > t) || Number(e === t) - 1) {
          return new this.constructor[Symbol.species]([
            ...this.entries(),
          ]).sort((t, i, s, n) => e(t, i, s, n));
        }
      }
    ...
    function (e, t, i) {
      ...
      e.exports = class RESTManager {
        ...
        request(e, t, i = {}) {
          ...
          return (
            o || ((o = new r(this)), this.handlers.set(n.route, o)),
            this.push(o, n)
          );
        }
        set endpoint(e) {
    ...
    function (e, t, i) {
      ...
      e.exports = class APIRequest {
        constructor(e, t, i, s) {
          ...
          let n = "";
          if (s.query) {
            const e = Object.entries(s.query).filter(([, e]) => null != e);
        ...
        make() {
          ...
          if (
            (!1 !== this.options.auth &&
              (i.Authorization = this.rest.getAuth()),
            this.options.reason &&
              (i["X-Audit-Log-Reason"] = encodeURIComponent(
                this.options.reason
              )),
            a || (i["User-Agent"] = c),
            this.options.headers &&
              (i = Object.assign(i, this.options.headers)),
            this.options.files && this.options.files.length)
          ) {
            t = new n();
            for (const e of this.options.files)
              e && e.file && t.append(e.name, e.file, e.name);
            void 0 !== this.options.data &&
              t.append("payload_json", JSON.stringify(this.options.data)),
              a || (i = Object.assign(i, t.getHeaders()));
          } else
            null != this.options.data &&
              ((t = JSON.stringify(this.options.data)),
              (i["Content-Type"] = "application/json"));
          const s = new r(),
            h = this.client.setTimeout(
              () => s.abort(),
    ...
    function (e, t, i) {
      "use strict";
      const { AbortController: s, AbortSignal: n } =
        ...
        const t = [""],
          i = {
            get(o, a) {
              ...
              if (n.includes(a)) {
                const i = [];
                for (let e = 0; e < t.length && "reactions" !== t[e - 1]; e++)
                  /\d{16,19}/g.test(t[e]) && !/channels|guilds/.test(t[e - 1])
                    ? i.push(":id")
                    : i.push(t[e]);
                return (s) =>
                  e.request(
                    ...
                    t.join("/"),
                    Object.assign(
                      { versioned: e.versioned, route: i.join("/") },
                      s
                    )
                  );
              }
            ...
            apply: (e, n, r) => (
              t.push(...r.filter((e) => null != e)), new Proxy(s, i)
            ),
          };
        ...
        async execute(e) {
          ...
          if (this.limited) {
            const e =
              ...
              Date.now();
            this.manager.client.listenerCount(r) &&
              this.manager.client.emit(r, {
                timeout: e,
                limit: this.limit,
                method: i.method,
                path: i.path,
          ...
          try {
            ...
            return (
              (this.busy = !1),
              t(
                new n(e.message, e.constructor.name, e.status, i.method, i.path)
              )
            );
          }
          if (h && h.headers) {
            const t = h.headers.get("date"),
              i = h.headers.get("x-ratelimit-limit"),
              s = h.headers.get("x-ratelimit-remaining"),
              n = h.headers.get("x-ratelimit-reset"),
              r = h.headers.get("retry-after");
            (this.limit = i ? Number(i) : 1 / 0),
              (this.remaining = s ? Number(s) : 1),
              (this.reset = n
                ? (function (e, t) {
                    return new Date(1e3 * Number(e)).getTime() - l(t);
                  })(n, t)
                : Date.now()),
              (this.retryAfter = r ? Number(r) : -1),
              e.request.route.includes("reactions") &&
                (this.reset = new Date(t).getTime() - l(t) + 250),
              h.headers.get("x-ratelimit-global") &&
                ((this.manager.globalTimeout = a.delayFor(this.retryAfter)),
                await this.manager.globalTimeout,
          ...
          if (429 === h.status)
            return (
              ...
              this.manager.client.emit(
                "debug",
                `429 hit on route ${e.request.route}`
              ),
              await a.delayFor(this.retryAfter),
              this.run()
            );
          if (h.status >= 500 && h.status < 600)
            return e.retries === this.manager.client.options.retryLimit
              ? t(
                  new n(
                    h.statusText,
                    h.constructor.name,
              ...
              : (e.retries++, this.queue.unshift(e), this.run());
          try {
            const e = await c(h);
            return h.status >= 400 && h.status < 500
              ? t(new s(i.path, e, i.method, h.status))
              : null;
          } catch (e) {
            return t(
              new n(e.message, e.constructor.name, e.status, i.method, i.path)
    ...
    function (module, exports, __webpack_require__) {
      ...
      (function (process) {
        const BaseClient = __webpack_require__(37),
          ActionsManager = __webpack_require__(108),
          ClientVoiceManager = __webpack_require__(158),
          WebSocketManager = __webpack_require__(159),
          {
            Error: Error,
            TypeError: TypeError,
            RangeError: RangeError,
          } = __webpack_require__(3),
          ChannelManager = __webpack_require__(93),
          GuildEmojiManager = __webpack_require__(57),
          GuildManager = __webpack_require__(94),
          UserManager = __webpack_require__(95),
          ShardClientUtil = __webpack_require__(204),
          ...
          Webhook = __webpack_require__(12),
          ...
          Intents = __webpack_require__(96),
        ...
        class Client extends BaseClient {
          constructor(e = {}) {
            ...
            this.options.shards === DefaultOptions.shards &&
              "SHARDS" in t &&
              ...
              this.options.shardCount === DefaultOptions.shardCount &&
                ("SHARD_COUNT" in t
                  ...
                  : Array.isArray(this.options.shards) &&
                    (this.options.shardCount = this.options.shards.length));
            const i = typeof this.options.shards;
            "undefined" === i &&
              "number" == typeof this.options.shardCount &&
              (this.options.shards = Array.from(
                { length: this.options.shardCount },
                (e, t) => t
              )),
              "number" === i && (this.options.shards = [this.options.shards]),
              Array.isArray(this.options.shards) &&
                (this.options.shards = [
                  ...new Set(
                    this.options.shards.filter(
                      (e) => !isNaN(e) && e >= 0 && e < 1 / 0 && e === (0 | e)
                    )
                  ),
                ]),
              ...
              (this.voice = browser ? null : new ClientVoiceManager(this)),
              (this.shard =
                !browser && process.env.SHARDING_MANAGER
                  ? ShardClientUtil.singleton(
                      this,
                      process.env.SHARDING_MANAGER_MODE
                    )
                  : null),
            ...
            (this.presence = new s(this)),
              ...
              browser || this.token || !("DISCORD_TOKEN" in process.env)
                ? (this.token = null)
          ...
          async login(e = this.token) {
            ...
            (this.token = e = e.replace(/^(Bot|Bearer)\s*/i, "")),
              ...
              this.options.presence &&
                (this.options.ws.presence = await this.presence._parse(
                  this.options.presence
                )),
          ...
          sweepMessages(e = this.options.messageCacheLifetime) {
            ...
            let s = 0,
              n = 0;
            for (const e of this.channels.cache.values())
              e.messages &&
                (s++,
                (n += e.messages.cache.sweep(
                  (e) => i - (e.editedTimestamp || e.createdTimestamp) > t
                )));
            return (
              this.emit(
                Events.DEBUG,
                `Swept ${n} messages older than ${e} seconds in ${s} text-based channels`
              ),
              n
            );
          }
          fetchApplication() {
            return this.api.oauth2
              .applications("@me")
              .get()
              .then((e) => new ClientApplication(this, e));
          }
          fetchGuildPreview(e) {
            ...
            return this.api
              .guilds(t)
              .preview.get()
              .then((e) => new GuildPreview(this, e));
          }
          ...
          _validateOptions(e = this.options) {
            if (
              (void 0 !== e.ws.intents &&
                (e.ws.intents = Intents.resolve(e.ws.intents)),
              "number" != typeof e.shardCount ||
                isNaN(e.shardCount) ||
                e.shardCount < 1)
            )
              throw new TypeError(
            ...
            if (e.shards && "auto" !== e.shards && !Array.isArray(e.shards))
              throw new TypeError(
                "CLIENT_INVALID_OPTION",
                "shards",
            ...
            if ("string" != typeof e.disableMentions)
              throw new TypeError(
                "CLIENT_INVALID_OPTION",
                "disableMentions",
                "a string"
            ...
            if (
              "number" != typeof e.restRequestTimeout ||
              isNaN(e.restRequestTimeout)
            )
              throw new TypeError(
                "CLIENT_INVALID_OPTION",
                "restRequestTimeout",
            ...
            if (
              "number" != typeof e.restSweepInterval ||
              isNaN(e.restSweepInterval)
            )
              throw new TypeError(
                "CLIENT_INVALID_OPTION",
                "restSweepInterval",
    ...
    function (e, t, i) {
      ...
      e.exports = class MessageCreateAction extends s {
        handle(e) {
          const t = this.client,
            i = t.channels.cache.get(e.channel_id);
          if (i) {
            const s = i.messages.cache.get(e.id);
            if (s) return { message: s };
            const r = i.messages.add(e),
              o = r.author;
            let a = r.member;
            return (
              (i.lastMessageID = e.id),
              o && ((o.lastMessageID = e.id), (o.lastMessageChannelID = i.id)),
              a && ((a.lastMessageID = e.id), (a.lastMessageChannelID = i.id)),
              t.emit(n.MESSAGE_CREATE, r),
              { message: r }
            );
          }
          return {};
        ...
        handle(e) {
          ...
          if (i) {
            ...
            for (const t of s) {
              ...
              s &&
                ((s.deleted = !0), o.set(s.id, s), i.messages.cache.delete(t));
            }
            return (
              o.size > 0 && t.emit(r.MESSAGE_BULK_DELETE, o), { messages: o }
            );
          }
          return {};
        }
    ...
    function (e, t, i) {
      ...
      e.exports = class MessageReactionAdd extends s {
        handle(e) {
          ...
          if (!s) return !1;
          if (s.partial && !this.client.options.partials.includes(r.REACTION))
            return !1;
          ...
          return (
            !!o &&
            (o._add(t),
            this.client.emit(n.MESSAGE_REACTION_ADD, o, t),
            { message: s, reaction: o, user: t })
          );
        }
      };
    },
      ...
      e.exports = class MessageReactionRemove extends s {
        handle(e) {
          ...
          return (
            !!r &&
            (r._remove(t),
            this.client.emit(n.MESSAGE_REACTION_REMOVE, r, t),
            { message: s, reaction: r, user: t })
          );
        }
      };
    },
      ...
      e.exports = class MessageReactionRemoveAll extends s {
        handle(e) {
          ...
          return (
            ...
            this.client.emit(n.MESSAGE_REACTION_REMOVE_ALL, i),
            { message: i })
          );
        }
      };
    ...
    function (e, t, i) {
      ...
      e.exports = class MessageReactionRemoveEmoji extends s {
        handle(e) {
          ...
          return (
            !!s &&
            (i.partial || i.reactions.cache.delete(s.emoji.id || s.emoji.name),
            this.client.emit(n.MESSAGE_REACTION_REMOVE_EMOJI, s),
            { reaction: s })
          );
        }
      };
    ...
    function (e, t, i) {
      ...
      e.exports = class ChannelDeleteAction extends s {
        ...
        handle(e) {
          ...
          if (i) {
            if (
              (t.channels.remove(i.id),
              (i.deleted = !0),
              i.messages && !(i instanceof n))
            )
              for (const e of i.messages.cache.values()) e.deleted = !0;
    ...
    function (e, t, i) {
      ...
      (function (e) {
            ...
            : (function (e, t) {
                ...
                if (t) {
                  if (
                    ...
                    return "number" != typeof t.length || (s = t.length) != s
                      ? a(e, 0)
                      : d(e, t);
        ...
        function u(e, t) {
          if ((h(t), (e = a(e, t < 0 ? 0 : 0 | p(t))), !c.TYPED_ARRAY_SUPPORT))
        ...
        function E(e, t, i, s, n) {
          ...
          if (("string" == typeof t && (t = c.from(t, s)), c.isBuffer(t)))
            return 0 === t.length ? -1 : _(e, t, i, s, n);
          if ("number" == typeof t)
            return (
              (t &= 255),
              c.TYPED_ARRAY_SUPPORT &&
        ...
        function _(e, t, i, s, n) {
          ...
          if (n) {
            var h = -1;
            for (r = i; r < a; r++)
              if (l(e, r) === l(t, -1 === h ? 0 : r - h)) {
                if ((-1 === h && (h = r), r - h + 1 === c)) return h * o;
              } else -1 !== h && (r -= r - h), (h = -1);
          } else
            for (i + c > a && (i = a - c), r = i; r >= 0; r--) {
        ...
        function T(e, t, i) {
          ...
          return (function (e) {
            ...
            var i = "",
              s = 0;
            for (; s < t; )
              i += String.fromCharCode.apply(String, e.slice(s, (s += 4096)));
            return i;
          })(s);
        }
        (t.Buffer = c),
          ...
          (c.compare = function (e, t) {
            ...
            if (e === t) return 0;
            for (
              var i = e.length, s = t.length, n = 0, r = Math.min(i, s);
              n < r;
              ++n
            )
              if (e[n] !== t[n]) {
          ...
          (c.prototype.compare = function (e, t, i, s, n) {
            ...
            if (
              ...
              t < 0 || i > e.length || s < 0 || n > this.length)
            )
        ...
        function O(e, t, i) {
          for (var s = e.slice(t, i), n = "", r = 0; r < s.length; r += 2)
        ...
        function M(e, t, i, s) {
          t < 0 && (t = 65535 + t + 1);
          for (var n = 0, r = Math.min(e.length - i, 2); n < r; ++n)
            e[i + n] =
              (t & (255 << (8 * (s ? n : 1 - n)))) >>> (8 * (s ? n : 1 - n));
        }
        function U(e, t, i, s) {
          t < 0 && (t = 4294967295 + t + 1);
          for (var n = 0, r = Math.min(e.length - i, 4); n < r; ++n)
            e[i + n] = (t >>> (8 * (s ? n : 3 - n))) & 255;
        }
        ...
        (c.prototype.slice = function (e, t) {
          ...
          (c.prototype.readUIntLE = function (e, t, i) {
            ...
            for (var s = this[e], n = 1, r = 0; ++r < t && (n *= 256); )
              s += this[e + r] * n;
            return s;
          }),
          (c.prototype.readUIntBE = function (e, t, i) {
            (e |= 0), (t |= 0), i || C(e, t, this.length);
            for (var s = this[e + --t], n = 1; t > 0 && (n *= 256); )
              s += this[e + --t] * n;
            return s;
          }),
          ...
          (c.prototype.readIntBE = function (e, t, i) {
            (e |= 0), (t |= 0), i || C(e, t, this.length);
            for (var s = t, n = 1, r = this[e + --s]; s > 0 && (n *= 256); )
              r += this[e + --s] * n;
          ...
          (c.prototype.writeUIntLE = function (e, t, i, s) {
            ((e = +e), (t |= 0), (i |= 0), s) ||
              L(this, e, t, i, Math.pow(2, 8 * i) - 1, 0);
            var n = 1,
              r = 0;
            for (this[t] = 255 & e; ++r < i && (n *= 256); )
              this[t + r] = (e / n) & 255;
            return t + i;
          }),
          ...
          (c.prototype.copy = function (e, t, i, s) {
            ...
            s > this.length && (s = this.length),
              e.length - t < s - i && (s = e.length - t + i);
            var n,
              r = s - i;
            if (this === e && i < t && t < s)
              for (n = r - 1; n >= 0; --n) e[n + t] = this[n + i];
            else if (r < 1e3 || !c.TYPED_ARRAY_SUPPORT)
              for (n = 0; n < r; ++n) e[n + t] = this[n + i];
          ...
          (c.prototype.fill = function (e, t, i, s) {
            ...
            if (
              ...
              var o = c.isBuffer(e) ? e : B(new c(e, s).toString()),
                a = o.length;
        ...
        function H(e, t, i, s) {
          for (var n = 0; n < s && !(n + i >= t.length || n >= e.length); ++n)
            t[n + i] = e[n];
          return n;
        }
      }.call(this, i(21)));
    ...
    function (e, t, i) {
      ...
      (t.byteLength = function (e) {
        ...
        (t.fromByteArray = function (e) {
          for (
            var t, i = e.length, n = i % 3, r = [], o = 0, a = i - n;
            o < a;
            o += 16383
          )
            r.push(h(e, o, o + 16383 > a ? a : o + 16383));
          1 === n
            ? ((t = e[i - 1]), r.push(s[t >> 2] + s[(t << 4) & 63] + "=="))
            : 2 === n &&
              ((t = (e[i - 2] << 8) + e[i - 1]),
    ...
    function (e, t) {
      (t.read = function (e, t, i, s, n) {
        var r,
          ...
          p = e[t + u];
        for (
          u += d, r = p & ((1 << -h) - 1), p >>= -h, h += a;
          h > 0;
          r = 256 * r + e[t + u], u += d, h -= 8
        );
        for (
          o = r & ((1 << -h) - 1), r >>= -h, h += s;
          h > 0;
              ...
              isNaN(t) || t === 1 / 0
                ...
                : ((o = Math.floor(Math.log(t) / Math.LN2)),
                  ...
                  o + u >= h
                    ? ((a = 0), (o = h))
                    : o + u >= 1
                    ? ((a = (t * c - 1) * Math.pow(2, n)), (o += u))
                    : ((a = t * Math.pow(2, u - 1) * Math.pow(2, n)), (o = 0)));
            n >= 8;
            e[i + p] = 255 & a, p += f, a /= 256, n -= 8
          );
          for (
            o = (o << n) | a, l += n;
            l > 0;
            e[i + p] = 255 & o, p += f, o /= 256, l -= 8
          );
          e[i + p - f] |= 128 * m;
        });
    },
      ...
      (e.exports = (function () {
        ...
        return (
          ...
          (e.prototype.concat = function (e) {
            ...
            for (
              var t, i, n, r = s.allocUnsafe(e >>> 0), o = this.head, a = 0;
              o;
    ...
    function (e, t, i) {
      e.exports = i(45).Transform;
    },
    function (e, t, i) {
      e.exports = i(45).PassThrough;
    },
    function (e, t, i) {
      "use strict";
      const s = i(6),
    ...
    function (e, t, i) {
      "use strict";
      const s = i(2);
      e.exports = class LimitedCollection extends s {
        constructor(e = 0, t = null) {
          super(t), (this.maxSize = e);
        }
        set(e, t) {
          return 0 === this.maxSize
            ? this
    ...
    function (e, t, i) {
      ...
      e.exports = class PartialGroupDMChannel extends s {
        ...
        iconURL({ format: e, size: t } = {}) {
          return this.icon
            ? this.client.rest.cdn.GDMIcon(this.id, this.icon, e, t)
            : null;
        }
        delete() {
        ...
        handle(e) {
          ...
          if (t) {
            ...
            if (r[t.type.toUpperCase()] !== e.type) {
              ...
              (i._typing = new Map(t._typing)),
                (t = i),
                this.client.channels.cache.set(t.id, t);
            }
        ...
        handle(e) {
          ...
          if (i) {
            ...
            if (e.unavailable)
              return (
                (i.available = !1),
                t.emit(n.GUILD_UNAVAILABLE, i),
                { guild: null }
              );
            for (const e of i.channels.cache.values())
              this.client.channels.remove(e.id);
            i.voice && i.voice.connection && i.voice.connection.disconnect(),
              t.guilds.cache.delete(i.id),
              (i.deleted = !0),
              t.emit(n.GUILD_DELETE, i),
              this.deleted.set(i.id, i),
              this.scheduleForDeletion(i.id);
    ...
    function (e, t, i) {
      ...
      e.exports = class InviteCreateAction extends s {
        handle(e) {
          ...
          if (!i && !s) return !1;
          const o = Object.assign(e, { channel: i, guild: s }),
            a = new n(t, o);
    ...
    function (e, t, i) {
      "use strict";
      const s = i(1),
        { Events: n, Status: r } = i(0);
      e.exports = class GuildMemberRemoveAction extends s {
        handle(e, t) {
          const i = this.client,
            s = i.guilds.cache.get(e.guild_id);
          let o = null;
          return (
            s &&
              ((o = this.getMember(e, s)),
              s.memberCount--,
              o &&
                ((o.deleted = !0),
                s.members.cache.delete(o.id),
                t.status === r.READY && i.emit(n.GUILD_MEMBER_REMOVE, o)),
      ...
      e.exports = class GuildRoleUpdateAction extends s {
        handle(e) {
          ...
          if (i) {
            ...
            return (
              r && ((s = r._update(e.role)), t.emit(n.GUILD_ROLE_UPDATE, s, r)),
              { old: s, updated: r }
            );
          }
          return { old: null, updated: null };
    ...
    function (e, t, i) {
      ...
      e.exports = class PresenceUpdateAction extends s {
        handle(e) {
          ...
          if (
            (!t && e.user.username && (t = this.client.users.add(e.user)), !t)
          )
            return;
          e.user &&
            e.user.username &&
            (t.equals(e.user) || this.client.actions.UserUpdate.handle(e.user));
          ...
          r ||
            ...
            this.client.emit(n.GUILD_MEMBER_AVAILABLE, r)),
            i.presences.add(Object.assign(e, { guild: i })),
            r &&
              this.client.listenerCount(n.PRESENCE_UPDATE) &&
              this.client.emit(n.PRESENCE_UPDATE, s, r.presence);
        }
      };
    },
    function (e, t, i) {
      ...
      e.exports = class UserUpdateAction extends s {
        handle(e) {
          const t = this.client,
            i = t.users.cache.get(e.id),
            s = i._update(e);
          return s.equals(i)
            ? { old: null, updated: null }
            : (t.emit(n.USER_UPDATE, s, i), { old: s, updated: i });
        }
      };
    },
    function (e, t, i) {
      ...
      e.exports = class VoiceStateUpdate extends s {
        handle(e) {
          const t = this.client,
            i = t.guilds.cache.get(e.guild_id);
          if (i) {
            const s = i.voiceStates.cache.has(e.user_id)
            ...
            a && e.member
              ...
              t.emit(r.VOICE_STATE_UPDATE, s, o);
          }
        }
      };
    },
      ...
      e.exports = class GuildEmojiDeleteAction extends s {
        handle(e) {
          return (
            ...
            (e.deleted = !0),
            this.client.emit(n.GUILD_EMOJI_DELETE, e),
            { emoji: e }
          );
        }
      };
    ...
    function (e, t, i) {
      ...
      const s = i(15),
        ...
        { Error: o } = i(3),
        a = i(2),
        { Events: c, ShardEvents: l, Status: h, WSCodes: u, WSEvents: d } = i(
          0
        ),
        p = i(4),
        f = [
          ...
          d.GUILD_CREATE,
          d.GUILD_DELETE,
          d.GUILD_MEMBERS_CHUNK,
          d.GUILD_MEMBER_ADD,
          d.GUILD_MEMBER_REMOVE,
        ],
        m = Object.keys(u).slice(1).map(Number),
        g = [1e3, 4006, 4007];
      e.exports = class WebSocketManager extends s {
        ...
        async connect() {
          ...
          return (
            "auto" === l &&
              ...
              (l = this.client.options.shards = Array.from(
                { length: i },
                (e, t) => t
              ))),
            (this.totalShards = l.length),
            this.debug(`Spawning shards: ${l.join(", ")}`),
            (this.shardQueue = new Set(l.map((e) => new n(this, e)))),
            await this._handleSessionLimit(a, c),
            this.createShards()
          );
        }
        async createShards() {
          ...
          this.shardQueue.delete(e),
            e.eventsAttached ||
              (e.on(l.ALL_READY, (t) => {
                this.client.emit(c.SHARD_READY, e.id, t),
                  this.shardQueue.size || (this.reconnecting = !1),
                  this.checkShardsReady();
              }),
              e.on(l.CLOSE, (t) => {
                if (1e3 === t.code ? this.destroyed : m.includes(t.code))
                  return (
                    this.client.emit(c.SHARD_DISCONNECT, t, e.id),
                    void this.debug(u[t.code], e)
                  );
                g.includes(t.code) && (e.sessionID = void 0),
                  ...
                  e.sessionID
                    ? (this.debug(
                      ...
                      this.reconnect(!0))
                    : (e.destroy({ reset: !0, emit: !1, log: !1 }),
                      this.reconnect());
              }),
        ...
        async reconnect(e = !1) {
          ...
          try {
            ...
            if (
              ...
              return (
                this.debug(
                  "Possible network error occurred. Retrying in 5s..."
                ),
                await p.delayFor(5e3),
                (this.reconnecting = !1),
                this.reconnect()
              );
            this.client.listenerCount(c.INVALIDATED)
              ? (this.client.emit(c.INVALIDATED), this.destroy())
              : this.client.destroy();
          } finally {
            this.reconnecting = !1;
          }
        ...
        destroy() {
          if (!this.destroyed) {
            ...
            for (const e of this.shards.values())
              e.destroy({ closeCode: 1e3, reset: !0, emit: !1, log: !1 });
          }
        }
        async _handleSessionLimit(e, t) {
          ...
          e ||
            (this.debug(
              `Exceeded identify threshold. Will attempt a connection in ${t}ms`
            ),
            await p.delayFor(t));
        }
        handlePacket(e, t) {
          if (e && this.status !== h.READY && !f.includes(e.t))
            return this.packetQueue.push({ packet: e, shard: t }), !1;
        ...
        async checkShardsReady() {
          if (
            ...
            !this.shards.some((e) => e.status !== h.READY)
          ) {
            if (((this.status = h.NEARLY), this.client.options.fetchAllMembers))
              try {
                const e = this.client.guilds.cache.map((e) =>
                  e.available ? e.members.fetch() : Promise.resolve()
                );
                await Promise.all(e);
              } catch (e) {
                this.debug(
        ...
        triggerClientReady() {
          (this.status = h.READY),
            ...
            this.client.emit(c.CLIENT_READY),
            this.handlePacket();
        }
      };
    },
      ...
      e.exports = class WebSocketShard extends s {
        ...
        connect() {
          ...
          return this.connection &&
            this.connection.readyState === n.OPEN &&
            this.status === o.READY
            ? Promise.resolve()
            : new Promise((i, s) => {
                const r = () => {
                    this.removeListener(c.CLOSE, h),
                      this.removeListener(c.READY, a),
                      this.removeListener(c.RESUMED, l),
                      this.removeListener(c.INVALID_SESSION, u),
                      this.removeListener(c.DESTROYED, u);
                  },
                  a = () => {
                    r(), i();
                  },
                ...
                if (
                  (this.once(c.READY, a),
                  this.once(c.RESUMED, l),
                  this.once(c.CLOSE, h),
                  this.once(c.INVALID_SESSION, u),
                  this.once(c.DESTROYED, u),
                  this.connection && this.connection.readyState === n.OPEN)
                )
                  return (
                    this.debug(
                ...
                this.connection &&
                  (this.debug(
                    `A connection object was found. Cleaning up before continuing.\n    State: ${
                      d[this.connection.readyState]
                    }`
                  ),
                  this.destroy({ emit: !1 }));
                const f = { v: t.options.ws.version };
                p &&
                  ((this.inflate = new p.Inflate({
                    chunkSize: 65535,
                    flush: p.Z_SYNC_FLUSH,
                    to: "json" === n.encoding ? "string" : "",
                  })),
                  (f.compress = "zlib-stream")),
                  this.debug(
                    `[CONNECT]\n    Gateway    : ${e}\n    Version    : ${
                      t.options.ws.version
                    }\n    Encoding   : ${n.encoding}\n    Compression: ${
                      p ? "zlib-stream" : "none"
                    }`
                  ),
                  (this.status =
                    this.status === o.DISCONNECTED
                      ? o.RECONNECTING
                      : o.CONNECTING),
                  this.setHelloTimeout(),
                  (this.connectedAt = Date.now());
                const m = (this.connection = n.create(e, f));
                (m.onopen = this.onOpen.bind(this)),
                  (m.onmessage = this.onMessage.bind(this)),
                  (m.onerror = this.onError.bind(this)),
                  (m.onclose = this.onClose.bind(this));
              });
        }
        onOpen() {
          this.debug(
            `[CONNECTED] ${this.connection.url} in ${
              Date.now() - this.connectedAt
            }ms`
          ),
            (this.status = o.NEARLY);
        }
        onMessage({ data: e }) {
          let t, i;
          ...
          try {
            (i = n.unpack(t)),
              this.manager.client.emit(a.RAW, i, this.id),
              i.op === l.DISPATCH && this.manager.emit(i.t, i.d, this.id);
          } catch (e) {
        ...
        onClose(e) {
          -1 !== this.sequence && (this.closeSequence = this.sequence),
            (this.sequence = -1),
            this.debug(
              `[CLOSE]\n    Event Code: ${e.code}\n    Clean     : ${
                e.wasClean
            ...
            this.connection && this._cleanupConnection(),
            (this.status = o.DISCONNECTED),
            this.emit(c.CLOSE, e);
        }
        onPacket(e) {
          if (e) {
            switch (e.t) {
              case h.READY:
                this.emit(c.READY),
                  ...
                  (this.status = o.WAITING_FOR_GUILDS),
            ...
            switch ((e.s > this.sequence && (this.sequence = e.s), e.op)) {
              ...
              case l.INVALID_SESSION:
                if ((this.debug(`[INVALID SESSION] Resumable: ${e.d}.`), e.d))
                  return void this.identifyResume();
                (this.sequence = -1),
                  (this.sessionID = void 0),
                  (this.status = o.RECONNECTING),
                  this.emit(c.INVALID_SESSION);
                break;
              ...
              default:
                this.manager.handlePacket(e, this),
                  this.status === o.WAITING_FOR_GUILDS &&
                    e.t === h.GUILD_CREATE &&
                    (this.expectedGuilds.delete(e.d.id), this.checkReady());
            }
        ...
        checkReady() {
          if (
            ...
            return (
              ...
              (this.status = o.READY),
              void this.emit(c.ALL_READY)
            );
          this.readyTimeout = this.manager.client.setTimeout(() => {
            this.debug(
              `Shard did not receive any more guild packets in 15 seconds.\n  Unavailable guild count: ${this.expectedGuilds.size}`
            ),
              (this.readyTimeout = void 0),
              (this.status = o.READY),
              this.emit(c.ALL_READY, this.expectedGuilds);
          }, 15e3);
        }
        setHelloTimeout(e) {
          -1 !== e
            ? (this.debug("Setting a HELLO timeout for 20s."),
              (this.helloTimeout = this.manager.client.setTimeout(() => {
                this.debug(
                  ...
                  this.destroy({ reset: !0, closeCode: 4009 });
              }, 2e4)))
            : this.helloTimeout &&
              (this.debug("Clearing the HELLO timeout."),
              this.manager.client.clearTimeout(this.helloTimeout),
              (this.helloTimeout = void 0));
        }
        setHeartbeatTimer(e) {
          -1 !== e
            ? (this.debug(`Setting a heartbeat interval for ${e}ms.`),
              ...
              (this.heartbeatInterval = this.manager.client.setInterval(
                () => this.sendHeartbeat(),
                e
              )))
            : this.heartbeatInterval &&
        ...
        sendHeartbeat(
          e = "HeartbeatTimer",
          t = [o.WAITING_FOR_GUILDS, o.IDENTIFYING, o.RESUMING].includes(
            this.status
          )
        ) {
          if (t && !this.lastHeartbeatAcked)
            ...
            return (
              ...
              void this.destroy({ closeCode: 4009, reset: !0 })
            );
          this.debug(`[${e}] Sending a heartbeat.`),
            (this.lastHeartbeatAcked = !1),
            (this.lastPingTimestamp = Date.now()),
            this.send({ op: l.HEARTBEAT, d: this.sequence }, !0);
        }
        ackHeartbeat() {
          this.lastHeartbeatAcked = !0;
        ...
        identifyNew() {
          ...
          this.debug(`[IDENTIFY] Shard ${this.id}/${e.options.shardCount}`),
            this.send({ op: l.IDENTIFY, d: t }, !0);
        }
        identifyResume() {
          if (!this.sessionID)
            return (
              ...
              void this.identifyNew()
            );
          (this.status = o.RESUMING),
            this.debug(
        ...
        _send(e) {
          if (!this.connection || this.connection.readyState !== n.OPEN)
            return (
              this.debug(
                `Tried to send packet '${JSON.stringify(
                  e
                )}' but no WebSocket is available!`
              ),
              void this.destroy({ close: 4e3 })
            );
        ...
        destroy({
          ...
          if (
            ...
            if (this.connection.readyState === n.OPEN) this.connection.close(e);
              ...
              this.debug(`WS State: ${d[this.connection.readyState]}`),
          ...
          (this.connection = null),
            (this.status = o.DISCONNECTED),
            -1 !== this.sequence && (this.closeSequence = this.sequence),
            t && ((this.sequence = -1), (this.sessionID = void 0)),
            (this.ratelimit.remaining = this.ratelimit.total),
            (this.ratelimit.queue.length = 0),
            this.ratelimit.timer &&
      ...
      (function (e) {
        var s =
            ...
            function (e) {
              for (var t = Object.keys(e), i = {}, s = 0; s < t.length; s++)
                i[t[s]] = Object.getOwnPropertyDescriptor(e, t[s]);
              return i;
            },
          n = /%[sdj%]/g;
        (t.format = function (e) {
          ...
          (t.deprecate = function (i, s) {
            ...
            return function () {
              if (!n) {
                ...
                e.traceDeprecation ? console.trace(s) : console.error(s),
                  (n = !0);
              }
        ...
        function a(e, i) {
          ...
          return (
            ...
            f(i) ? (s.showHidden = i) : i && t._extend(s, i),
            _(s.showHidden) && (s.showHidden = !1),
            _(s.depth) && (s.depth = 2),
            _(s.colors) && (s.colors = !1),
            _(s.customInspect) && (s.customInspect = !0),
            s.colors && (s.stylize = c),
            h(s, e, s.depth)
          );
        }
        function c(e, t) {
          var i = a.styles[t];
          return i
            ? "[" + a.colors[i][0] + "m" + e + "[" + a.colors[i][1] + "m"
            : e;
        }
        function l(e, t) {
          return e;
        ...
        function h(e, i, s) {
          ...
          if (0 === o.length) {
            ...
            if (v(i)) return e.stylize(Date.prototype.toString.call(i), "date");
            if (w(i)) return u(i);
          }
          var l,
            b = "",
            ...
            I = ["{", "}"];
          (p(i) && ((S = !0), (I = ["[", "]"])), A(i)) &&
            (b = " [Function" + (i.name ? ": " + i.name : "") + "]");
          return (
            y(i) && (b = " " + RegExp.prototype.toString.call(i)),
            v(i) && (b = " " + Date.prototype.toUTCString.call(i)),
            w(i) && (b = " " + u(i)),
            0 !== o.length || (S && 0 != i.length)
              ? s < 0
                ? y(i)
        ...
        function d(e, t, i, s, n, r) {
          var o, a, c;
          if (
            ((c = Object.getOwnPropertyDescriptor(t, n) || { value: t[n] }).get
              ? (a = c.set
        ...
        (t.debuglog = function (i) {
          if (
            (_(r) && (r = e.env.NODE_DEBUG || ""), (i = i.toUpperCase()), !o[i])
          )
    ...
    function (e, t, i) {
      ...
      e.exports = (e, { d: t }) => {
        ...
        i &&
          ...
          ((i.lastPinTimestamp = n.getTime() || null),
          e.emit(s.CHANNEL_PINS_UPDATE, i, n));
      };
    },
    function (e, t, i) {
      "use strict";
      ...
      e.exports = async (e, { d: t }, i) => {
        ...
        r
          ? r.available ||
            ...
            (r._patch(t),
            e.ws.status === n.READY &&
              e.options.fetchAllMembers &&
              (await r.members
                .fetch()
                .catch((t) =>
                  e.emit(
                    s.DEBUG,
                    `Failed to fetch all members: ${t}\n${t.stack}`
                  )
                )))
          : ((t.shardID = i.id),
            (r = e.guilds.add(t)),
      ...
      e.exports = (e, { d: t }) => {
        ...
        if (t.presences)
          for (const e of t.presences)
            i.presences.cache.add(Object.assign(e, { guild: i }));
        e.emit(n.GUILD_MEMBERS_CHUNK, r, i);
      };
    },
    function (e, t, i) {
      "use strict";
      ...
      e.exports = (e, { d: t }) => {
        ...
        if (i && r) {
          if ("voice" === i.type)
            return void e.emit(
              s.WARN,
              `Discord sent a typing packet to a voice channel ${i.id}`
            );
          if (i._typing.has(r.id)) {
            const t = i._typing.get(r.id);
            (t.lastTimestamp = o),
              (t.elapsedTime = Date.now() - t.since),
              e.clearTimeout(t.timeout),
              (t.timeout = n(i, r));
          } else {
            const t = new Date(),
              o = new Date();
    ...
    function (e, t, i) {
      ...
      (Speaking.FLAGS = { SPEAKING: 1, SOUNDSHARE: 2, PRIORITY_SPEAKING: 4 }),
        (e.exports = Speaking);
    },
  ]);
});
