...
class PermissionOverwrites {
  ...
  update(options, reason) {
    const { allow, deny } = this.constructor.resolveOverwriteOptions(
      options,
      this
    );
  ...
  static resolve(overwrite, guild) {
    ...
    if (
      ...
      ["role", "member"].includes(overwrite.type)
    ) {
      return {
        ...overwrite,
    ...
    if (!userOrRole)
      throw new TypeError("INVALID_TYPE", "parameter", "User nor a Role", true);
