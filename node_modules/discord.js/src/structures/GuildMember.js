...
class GuildMember extends Base {
  ...
  get manageable() {
    ...
    return (
      this.guild.me.roles.highest.comparePositionTo(this.roles.highest) > 0
    );
  }
  ...
  get kickable() {
    return (
      this.manageable &&
      this.guild.me.permissions.has(Permissions.FLAGS.KICK_MEMBERS)
    );
  }
  ...
  get bannable() {
    return (
      this.manageable &&
      this.guild.me.permissions.has(Permissions.FLAGS.BAN_MEMBERS)
    );
  }
  ...
  hasPermission(permission, { checkAdmin = true, checkOwner = true } = {}) {
    ...
    return this.roles.cache.some((r) =>
      r.permissions.has(permission, checkAdmin)
    );
  }
