...
class GuildChannel extends Channel {
  ...
  get permissionsLocked() {
    ...
    if (
      this.permissionOverwrites.size !== this.parent.permissionOverwrites.size
    )
      return false;
  ...
  overwritePermissions(overwrites, reason) {
    ...
    return this.edit({ permissionOverwrites: overwrites, reason }).then(
      () => this
    );
  }
  ...
  updateOverwrite(userOrRole, options, reason) {
    userOrRole =
      this.guild.roles.resolve(userOrRole) ||
      this.client.users.resolve(userOrRole);
    if (!userOrRole)
      return Promise.reject(
        new TypeError("INVALID_TYPE", "parameter", "User nor a Role", true)
      );
