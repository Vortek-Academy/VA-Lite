...
class Invite extends Base {
  ...
  _patch(data) {
     ...
     */
    this.memberCount =
      "approximate_member_count" in data ? data.approximate_member_count : null;
    ...
    this.targetUser = data.target_user
      ? this.client.users.add(data.target_user)
      : null;
     ...
     */
    this.targetUserType =
      typeof data.target_user_type === "number" ? data.target_user_type : null;
    ...
    this.createdTimestamp =
      "created_at" in data ? new Date(data.created_at).getTime() : null;
  }
  ...
  get expiresTimestamp() {
    return this.createdTimestamp && this.maxAge
      ? this.createdTimestamp + this.maxAge * 1000
      : null;
  }
