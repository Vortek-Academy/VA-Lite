...
class GuildManager extends BaseManager {
  ...
  async create(
    ...
    if (
      typeof verificationLevel !== "undefined" &&
      typeof verificationLevel !== "number"
    ) {
      verificationLevel = VerificationLevels.indexOf(verificationLevel);
    }
    if (
      typeof defaultMessageNotifications !== "undefined" &&
      typeof defaultMessageNotifications !== "number"
    ) {
      defaultMessageNotifications = DefaultMessageNotifications.indexOf(
        defaultMessageNotifications
      );
    }
    if (
      typeof explicitContentFilter !== "undefined" &&
      typeof explicitContentFilter !== "number"
    ) {
      explicitContentFilter = ExplicitContentFilterLevels.indexOf(
        explicitContentFilter
      );
    }
