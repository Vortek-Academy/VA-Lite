...
declare module "discord.js" {
  ...
  export class ActivityFlags extends BitField<ActivityFlagsString> {
    ...
    public static resolve(
      bit?: BitFieldResolvable<ActivityFlagsString>
    ): number;
  }
  ...
  export class BitField<S extends string> {
    ...
    public missing(
      bits: BitFieldResolvable<S>,
      ...hasParam: readonly unknown[]
    ): S[];
  ...
  export abstract class Collector<K, V> extends EventEmitter {
    ...
    public on(
      event: "end",
      listener: (collected: Collection<K, V>, reason: string) => void
    ): this;
  ...
  export class Guild extends Base {
    ...
    public fetchBan(
      user: UserResolvable
    ): Promise<{ user: User; reason: string }>;
    public fetchBans(): Promise<
      Collection<Snowflake, { user: User; reason: string }>
    >;
  ...
  export class Permissions extends BitField<PermissionString> {
    ...
    public missing(
      bits: BitFieldResolvable<PermissionString>,
      checkAdmin?: boolean
    ): PermissionString[];
  ...
  export class Shard extends EventEmitter {
    ...
    public on(
      event: "spawn" | "death",
      listener: (child: ChildProcess) => void
    ): this;
    public on(
      event: "disconnect" | "ready" | "reconnecting",
      listener: () => void
    ): this;
  ...
  export class SystemChannelFlags extends BitField<SystemChannelFlagsString> {
    ...
    public static resolve(
      bit?: BitFieldResolvable<SystemChannelFlagsString>
    ): number;
  }
  ...
  export class Util {
    ...
    public static makeError(obj: {
      name: string;
      message: string;
      stack: string;
    }): Error;
    public static makePlainError(
      err: Error
    ...
    public static parseEmoji(
      text: string
    ): { animated: boolean; name: string; id: string | null } | null;
  ...
  class VoiceBroadcast extends EventEmitter {
    ...
    public on(
      ...
      listener: (dispatcher: StreamDispatcher) => void
    ): this;
    public on(event: string, listener: (...args: any[]) => void): this;
  ...
  class VoiceConnection extends EventEmitter {
    ...
    public once(
      event: "warn",
      listener: (warning: string | Error) => void
    ): this;
    public once(event: string, listener: (...args: any[]) => void): this;
  }
  ...
  export class WebSocketShard extends EventEmitter {
    ...
    public on(
      event: "ready" | "resumed" | "invalidSession",
      listener: () => void
    ): this;
    public on(event: "close", listener: (event: CloseEvent) => void): this;
    public on(
      event: "allReady",
      listener: (unavailableGuilds?: Set<Snowflake>) => void
    ): this;
    public on(event: string, listener: (...args: any[]) => void): this;
  ...
  > {
    ...
    public create(
      name: string,
      options: GuildCreateChannelOptions & { type: "category" }
  ...
  export class GuildEmojiManager extends BaseManager<
    Snowflake,
    GuildEmoji,
    EmojiResolvable
  > {
  ...
  export class GuildEmojiRoleManager {
    ...
    public set(
      roles: RoleResolvable[] | Collection<Snowflake, Role>
    ): Promise<GuildEmoji>;
    public remove(
      roleOrRoles:
        | RoleResolvable
  ...
  export class GuildMemberRoleManager extends OverridableManager<
    Snowflake,
    Role,
    RoleResolvable
  > {
  ...
  export class VoiceStateManager extends BaseManager<
    Snowflake,
    VoiceState,
    typeof VoiceState
  > {
  ...
  function PartialTextBasedChannel<T>(
    Base?: Constructable<T>
  ): Constructable<T & PartialTextBasedChannelFields>;
  function TextBasedChannel<T>(
    Base?: Constructable<T>
  ): Constructable<T & TextBasedChannelFields>;
  ...
  function WebhookMixin<T>(
    Base?: Constructable<T>
  ): Constructable<T & WebhookFields>;

  function VolumeMixin<T>(
    base: Constructable<T>
  ...
  interface WebhookFields {
    ...
    send(
      content?: StringResolvable,
      options?:
        | (WebhookMessageOptions & { split: true | SplitOptions })
        | MessageAdditions
    ): Promise<Message[]>;
    send(
      options?:
  ...
  interface PermissionOverwriteOption
    extends Partial<Record<PermissionString, boolean | null>> {}
  ...
  interface PartialUser
    extends Partialize<User, "discriminator" | "username" | "tag"> {
