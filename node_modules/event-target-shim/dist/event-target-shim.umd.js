 ...
 */ (function (a, b) {
  ...
  function e(a, b) {
    ...
    for (var c, d = Object.keys(b), e = 0; e < d.length; ++e)
      (c = d[e]), c in this || Object.defineProperty(this, c, f(c));
  }
  function f(a) {
    return {
      get: function () {
        return c(this).event[a];
      },
      set: function (b) {
        c(this).event[a] = b;
      },
  ...
  function h(a, b) {
    ...
    for (var e, h = 0; h < d.length; ++h)
      if (((e = d[h]), !(e in a.prototype))) {
        var j = Object.getOwnPropertyDescriptor(b, e),
          k = "function" == typeof j.value;
        Object.defineProperty(c.prototype, e, k ? g(e) : f(e));
      }
    return c;
  }
  function i(a) {
    if (null == a || a === Object.prototype) return e;
    var b = v.get(a);
    return (
      null == b && ((b = h(i(Object.getPrototypeOf(a)), a)), v.set(a, b)), b
    );
  }
  function j(a, b) {
    var c = i(Object.getPrototypeOf(b));
    return new c(a, b);
  }
  function k(a) {
    return c(a).immediateStopped;
  }
  function l(a, b) {
    c(a).eventPhase = b;
  }
  ...
  function q(a) {
    return {
      get: function () {
        for (var b = p(this), c = b.get(a); null != c; ) {
      ...
      set: function (b) {
        "function" == typeof b || o(b) || (b = null);
        for (var c = p(this), d = null, e = c.get(a); null != e; )
          3 === e.listenerType
            ? null === d
              ? null === e.next
                ? c.delete(a)
  ...
  function r(a, b) {
    Object.defineProperty(a, "on".concat(b), q(b));
  }
  function s(a) {
    function b() {
      t.call(this);
    ...
    for (var c = 0; c < a.length; ++c) r(b.prototype, a[c]);
    return b;
  }
  function t() {
    if (this instanceof t) return void w.set(this, new Map());
    if (1 === arguments.length && Array.isArray(arguments[0]))
      return s(arguments[0]);
    if (0 < arguments.length) {
      for (var a = Array(arguments.length), b = 0; b < arguments.length; ++b)
        a[b] = arguments[b];
      return s(a);
    }
  ...
  (e.prototype = {
    ...
    get bubbles() {
      return !!c(this).event.bubbles;
    },
    get cancelable() {
      return !!c(this).event.cancelable;
    },
    ...
    "undefined" != typeof window &&
      ...
      (Object.setPrototypeOf(e.prototype, window.Event.prototype),
      v.set(window.Event.prototype, e));
  var w = new WeakMap(),
    x = 1,
    y = 2;
  if (
    ((t.prototype = {
      ...
      dispatchEvent: function (a) {
        ...
        var b = p(this),
          ...
          d = b.get(c);
        if (null == d) return !0;
        for (var e = j(this, a), f = null; null != d; ) {
          if (
            (d.once
              ? null === f
                ? null === d.next
        ...
        return n(e, null), l(e, 0), m(e, null), !e.defaultPrevented;
      },
    }),
    ...
    (z.EventTargetShim = t), (z.EventTargetShim.defineEventAttribute = r);
  }
});
